...
module AmzSpApi::VendorShipmentsApiModel
  class VendorShippingApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [SubmitShipmentConfirmationResponse]
    def submit_shipment_confirmation(body, opts = {})
      data, _status_code, _headers = submit_shipment_confirmation_with_http_info(body, opts)
      data
    end
    ...
    # @param body A request to submit shipment confirmation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubmitShipmentConfirmationResponse, Integer, Hash)>] SubmitShipmentConfirmationResponse data, response status code and response headers
    def submit_shipment_confirmation_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VendorShippingApi.submit_shipment_confirmation ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling VendorShippingApi.submit_shipment_confirmation"
      end
      # resource path
      local_var_path = '/vendor/shipping/v1/shipmentConfirmation'
      ...
      return_type = opts[:return_type] || 'SubmitShipmentConfirmationResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VendorShippingApi#submit_shipment_confirmation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
