...
require 'vendor-shipments-api-model/models/regulation_references'
...
require 'vendor-shipments-api-model/models/submit_shipment_confirmation_request'
require 'vendor-shipments-api-model/models/submit_shipment_confirmation_response'
