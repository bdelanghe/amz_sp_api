# AmzSpApi::UploadsApiModel20201101::UploadsApi
...
```ruby
# load the gem
require 'uploads-api-model_20201101'

api_instance = AmzSpApi::UploadsApiModel20201101::UploadsApi.new
...
begin
  ...
  p result
rescue AmzSpApi::UploadsApiModel20201101::ApiError => e
