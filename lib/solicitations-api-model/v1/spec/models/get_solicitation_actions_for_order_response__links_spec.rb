...
# Unit tests for AmzSpApi::SolicitationsApiModel::V1::GetSolicitationActionsForOrderResponseLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSolicitationActionsForOrderResponseLinks' do
  before do
    # run before each test
    @instance = AmzSpApi::SolicitationsApiModel::V1::GetSolicitationActionsForOrderResponseLinks.new
  end
  ...
  describe 'test an instance of GetSolicitationActionsForOrderResponseLinks' do
    it 'should create an instance of GetSolicitationActionsForOrderResponseLinks' do
      expect(@instance).to be_instance_of(AmzSpApi::SolicitationsApiModel::V1::GetSolicitationActionsForOrderResponseLinks)
    end
  end
