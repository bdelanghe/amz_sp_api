...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::PartneredSmallParcelPackageOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartneredSmallParcelPackageOutput' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::PartneredSmallParcelPackageOutput.new
  end
  ...
  describe 'test an instance of PartneredSmallParcelPackageOutput' do
    it 'should create an instance of PartneredSmallParcelPackageOutput' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::PartneredSmallParcelPackageOutput)
    end
  end
