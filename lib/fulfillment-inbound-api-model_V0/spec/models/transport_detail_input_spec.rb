...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::TransportDetailInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportDetailInput' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::TransportDetailInput.new
  end
  ...
  describe 'test an instance of TransportDetailInput' do
    it 'should create an instance of TransportDetailInput' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::TransportDetailInput)
    end
  end
