...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::InboundShipmentPlanRequestItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundShipmentPlanRequestItem' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::InboundShipmentPlanRequestItem.new
  end
  ...
  describe 'test an instance of InboundShipmentPlanRequestItem' do
    it 'should create an instance of InboundShipmentPlanRequestItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::InboundShipmentPlanRequestItem)
    end
  end
