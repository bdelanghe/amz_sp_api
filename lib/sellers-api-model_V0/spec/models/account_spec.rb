...
# Unit tests for AmzSpApi::SellersApiModelV0::Account
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Account' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModelV0::Account.new
  end
  ...
  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModelV0::Account)
    end
  end
