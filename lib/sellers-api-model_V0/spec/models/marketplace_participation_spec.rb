...
# Unit tests for AmzSpApi::SellersApiModelV0::MarketplaceParticipation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceParticipation' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModelV0::MarketplaceParticipation.new
  end
  ...
  describe 'test an instance of MarketplaceParticipation' do
    it 'should create an instance of MarketplaceParticipation' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModelV0::MarketplaceParticipation)
    end
  end
