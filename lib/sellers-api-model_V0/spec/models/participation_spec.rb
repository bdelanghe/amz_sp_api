...
# Unit tests for AmzSpApi::SellersApiModelV0::Participation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Participation' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModelV0::Participation.new
  end
  ...
  describe 'test an instance of Participation' do
    it 'should create an instance of Participation' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModelV0::Participation)
    end
  end
