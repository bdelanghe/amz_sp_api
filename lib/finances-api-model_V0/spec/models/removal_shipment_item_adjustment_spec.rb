...
# Unit tests for AmzSpApi::FinancesApiModelV0::RemovalShipmentItemAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemovalShipmentItemAdjustment' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModelV0::RemovalShipmentItemAdjustment.new
  end
  ...
  describe 'test an instance of RemovalShipmentItemAdjustment' do
    it 'should create an instance of RemovalShipmentItemAdjustment' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModelV0::RemovalShipmentItemAdjustment)
    end
  end
