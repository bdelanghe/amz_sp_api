...
# Unit tests for AmzSpApi::FinancesApiModelV0::AdjustmentItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdjustmentItem' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModelV0::AdjustmentItem.new
  end
  ...
  describe 'test an instance of AdjustmentItem' do
    it 'should create an instance of AdjustmentItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModelV0::AdjustmentItem)
    end
  end
