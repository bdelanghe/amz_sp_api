...
# Unit tests for AmzSpApi::FinancesApiModelV0::SAFETReimbursementItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SAFETReimbursementItem' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModelV0::SAFETReimbursementItem.new
  end
  ...
  describe 'test an instance of SAFETReimbursementItem' do
    it 'should create an instance of SAFETReimbursementItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModelV0::SAFETReimbursementItem)
    end
  end
