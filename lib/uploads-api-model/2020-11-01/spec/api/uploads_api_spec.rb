...
# Unit tests for AmzSpApi::UploadsApiModel::2020_11_01::UploadsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::UploadsApiModel::2020_11_01::UploadsApi.new
  end
  ...
  describe 'test an instance of UploadsApi' do
    it 'should create an instance of UploadsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::UploadsApiModel::2020_11_01::UploadsApi)
    end
  end
