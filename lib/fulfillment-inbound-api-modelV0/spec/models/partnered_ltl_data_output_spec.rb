...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0V0::PartneredLtlDataOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartneredLtlDataOutput' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0V0::PartneredLtlDataOutput.new
  end
  ...
  describe 'test an instance of PartneredLtlDataOutput' do
    it 'should create an instance of PartneredLtlDataOutput' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0V0::PartneredLtlDataOutput)
    end
  end
