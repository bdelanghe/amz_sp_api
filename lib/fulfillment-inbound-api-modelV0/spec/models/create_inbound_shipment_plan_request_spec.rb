...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0V0::CreateInboundShipmentPlanRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateInboundShipmentPlanRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0V0::CreateInboundShipmentPlanRequest.new
  end
  ...
  describe 'test an instance of CreateInboundShipmentPlanRequest' do
    it 'should create an instance of CreateInboundShipmentPlanRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0V0::CreateInboundShipmentPlanRequest)
    end
  end
