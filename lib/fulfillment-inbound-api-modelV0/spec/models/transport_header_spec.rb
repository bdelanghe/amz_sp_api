...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0V0::TransportHeader
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportHeader' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0V0::TransportHeader.new
  end
  ...
  describe 'test an instance of TransportHeader' do
    it 'should create an instance of TransportHeader' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0V0::TransportHeader)
    end
  end
