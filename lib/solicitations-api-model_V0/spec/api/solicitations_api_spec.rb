...
# Unit tests for AmzSpApi::SolicitationsApiModelV0::SolicitationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolicitationsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::SolicitationsApiModelV0::SolicitationsApi.new
  end
  ...
  describe 'test an instance of SolicitationsApi' do
    it 'should create an instance of SolicitationsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::SolicitationsApiModelV0::SolicitationsApi)
    end
  end
