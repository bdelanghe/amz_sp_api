...
# Unit tests for AmzSpApi::FbaInboundEligibilityApiModelV0::ItemEligibilityPreview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemEligibilityPreview' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaInboundEligibilityApiModelV0::ItemEligibilityPreview.new
  end
  ...
  describe 'test an instance of ItemEligibilityPreview' do
    it 'should create an instance of ItemEligibilityPreview' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaInboundEligibilityApiModelV0::ItemEligibilityPreview)
    end
  end
