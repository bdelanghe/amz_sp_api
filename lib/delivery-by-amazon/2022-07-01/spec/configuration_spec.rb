...
describe AmzSpApi::DeliveryByAmazon::2022_07_01::Configuration do
  let(:config) { AmzSpApi::DeliveryByAmazon::2022_07_01::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::DeliveryByAmazon::2022_07_01.configure do |c|
    #   c.host = uri.host
