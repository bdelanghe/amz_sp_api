...
# Unit tests for AmzSpApi::DeliveryByAmazon::2022_07_01::SubmitInvoiceResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubmitInvoiceResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::DeliveryByAmazon::2022_07_01::SubmitInvoiceResponse.new
  end
  ...
  describe 'test an instance of SubmitInvoiceResponse' do
    it 'should create an instance of SubmitInvoiceResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::DeliveryByAmazon::2022_07_01::SubmitInvoiceResponse)
    end
  end
