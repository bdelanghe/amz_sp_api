...
# Unit tests for AmzSpApi::DeliveryByAmazon::2022_07_01::GetInvoiceStatusResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInvoiceStatusResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::DeliveryByAmazon::2022_07_01::GetInvoiceStatusResponse.new
  end
  ...
  describe 'test an instance of GetInvoiceStatusResponse' do
    it 'should create an instance of GetInvoiceStatusResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::DeliveryByAmazon::2022_07_01::GetInvoiceStatusResponse)
    end
  end
