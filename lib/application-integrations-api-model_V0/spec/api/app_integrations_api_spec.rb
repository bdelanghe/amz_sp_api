...
# Unit tests for AmzSpApi::ApplicationIntegrationsApiModelV0::AppIntegrationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppIntegrationsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationIntegrationsApiModelV0::AppIntegrationsApi.new
  end
  ...
  describe 'test an instance of AppIntegrationsApi' do
    it 'should create an instance of AppIntegrationsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationIntegrationsApiModelV0::AppIntegrationsApi)
    end
  end
