...
# Unit tests for AmzSpApi::ApplicationIntegrationsApiModelV0::CreateNotificationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateNotificationRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationIntegrationsApiModelV0::CreateNotificationRequest.new
  end
  ...
  describe 'test an instance of CreateNotificationRequest' do
    it 'should create an instance of CreateNotificationRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationIntegrationsApiModelV0::CreateNotificationRequest)
    end
  end
