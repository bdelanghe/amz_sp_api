...
# Unit tests for AmzSpApi::ReplenishmentApiModel::2022_11_07::ListOfferMetricsRequestFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListOfferMetricsRequestFilters' do
  before do
    # run before each test
    @instance = AmzSpApi::ReplenishmentApiModel::2022_11_07::ListOfferMetricsRequestFilters.new
  end
  ...
  describe 'test an instance of ListOfferMetricsRequestFilters' do
    it 'should create an instance of ListOfferMetricsRequestFilters' do
      expect(@instance).to be_instance_of(AmzSpApi::ReplenishmentApiModel::2022_11_07::ListOfferMetricsRequestFilters)
    end
  end
