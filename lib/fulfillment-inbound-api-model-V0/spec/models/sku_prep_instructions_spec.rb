...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::SKUPrepInstructions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SKUPrepInstructions' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::SKUPrepInstructions.new
  end
  ...
  describe 'test an instance of SKUPrepInstructions' do
    it 'should create an instance of SKUPrepInstructions' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::SKUPrepInstructions)
    end
  end
