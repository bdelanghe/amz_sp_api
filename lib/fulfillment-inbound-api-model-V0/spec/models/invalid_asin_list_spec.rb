...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::InvalidASINList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvalidASINList' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::InvalidASINList.new
  end
  ...
  describe 'test an instance of InvalidASINList' do
    it 'should create an instance of InvalidASINList' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::InvalidASINList)
    end
  end
end
