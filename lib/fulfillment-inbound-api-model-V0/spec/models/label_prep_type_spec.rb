...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::LabelPrepType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelPrepType' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::LabelPrepType.new
  end
  ...
  describe 'test an instance of LabelPrepType' do
    it 'should create an instance of LabelPrepType' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::LabelPrepType)
    end
  end
end
