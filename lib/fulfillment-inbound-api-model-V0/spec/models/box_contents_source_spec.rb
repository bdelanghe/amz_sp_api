...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::BoxContentsSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BoxContentsSource' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::BoxContentsSource.new
  end
  ...
  describe 'test an instance of BoxContentsSource' do
    it 'should create an instance of BoxContentsSource' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::BoxContentsSource)
    end
  end
end
