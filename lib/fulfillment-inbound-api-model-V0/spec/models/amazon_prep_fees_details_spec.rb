...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::AmazonPrepFeesDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonPrepFeesDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::AmazonPrepFeesDetails.new
  end
  ...
  describe 'test an instance of AmazonPrepFeesDetails' do
    it 'should create an instance of AmazonPrepFeesDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::AmazonPrepFeesDetails)
    end
  end
