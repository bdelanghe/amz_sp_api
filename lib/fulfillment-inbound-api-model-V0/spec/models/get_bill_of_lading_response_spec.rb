...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::GetBillOfLadingResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetBillOfLadingResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::GetBillOfLadingResponse.new
  end
  ...
  describe 'test an instance of GetBillOfLadingResponse' do
    it 'should create an instance of GetBillOfLadingResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::GetBillOfLadingResponse)
    end
  end
