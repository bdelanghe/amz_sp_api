...
# Unit tests for AmzSpApi::FulfillmentInboundApiModelV0::Amount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Amount' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModelV0::Amount.new
  end
  ...
  describe 'test an instance of Amount' do
    it 'should create an instance of Amount' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModelV0::Amount)
    end
  end
