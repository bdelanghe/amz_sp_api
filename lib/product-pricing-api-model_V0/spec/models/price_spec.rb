...
# Unit tests for AmzSpApi::ProductPricingApiModelV0::Price
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Price' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModelV0::Price.new
  end
  ...
  describe 'test an instance of Price' do
    it 'should create an instance of Price' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModelV0::Price)
    end
  end
