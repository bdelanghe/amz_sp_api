...
# Unit tests for AmzSpApi::SalesApiModel::V1::SalesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::SalesApiModel::V1::SalesApi.new
  end
  ...
  describe 'test an instance of SalesApi' do
    it 'should create an instance of SalesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::SalesApiModel::V1::SalesApi)
    end
  end
