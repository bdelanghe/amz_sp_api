...
# Unit tests for AmzSpApi::ProductFeesApiModel::V0::FeesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModel::V0::FeesApi.new
  end
  ...
  describe 'test an instance of FeesApi' do
    it 'should create an instance of FeesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModel::V0::FeesApi)
    end
  end
