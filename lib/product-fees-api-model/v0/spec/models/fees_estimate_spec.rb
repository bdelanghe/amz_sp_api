...
# Unit tests for AmzSpApi::ProductFeesApiModel::V0::FeesEstimate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimate' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModel::V0::FeesEstimate.new
  end
  ...
  describe 'test an instance of FeesEstimate' do
    it 'should create an instance of FeesEstimate' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModel::V0::FeesEstimate)
    end
  end
