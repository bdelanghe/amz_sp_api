...
# Unit tests for AmzSpApi::ProductFeesApiModel::V0::Points
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Points' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModel::V0::Points.new
  end
  ...
  describe 'test an instance of Points' do
    it 'should create an instance of Points' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModel::V0::Points)
    end
  end
