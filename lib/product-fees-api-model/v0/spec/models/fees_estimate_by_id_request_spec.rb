...
# Unit tests for AmzSpApi::ProductFeesApiModel::V0::FeesEstimateByIdRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimateByIdRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModel::V0::FeesEstimateByIdRequest.new
  end
  ...
  describe 'test an instance of FeesEstimateByIdRequest' do
    it 'should create an instance of FeesEstimateByIdRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModel::V0::FeesEstimateByIdRequest)
    end
  end
