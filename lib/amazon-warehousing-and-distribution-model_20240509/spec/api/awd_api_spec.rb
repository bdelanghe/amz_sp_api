...
# Unit tests for AmzSpApi::AmazonWarehousingAndDistributionModel20240509::AwdApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwdApi' do
  before do
    # run before each test
    @instance = AmzSpApi::AmazonWarehousingAndDistributionModel20240509::AwdApi.new
  end
  ...
  describe 'test an instance of AwdApi' do
    it 'should create an instance of AwdApi' do
      expect(@instance).to be_instance_of(AmzSpApi::AmazonWarehousingAndDistributionModel20240509::AwdApi)
    end
  end
