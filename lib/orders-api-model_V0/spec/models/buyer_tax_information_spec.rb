...
# Unit tests for AmzSpApi::OrdersApiModelV0::BuyerTaxInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerTaxInformation' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::BuyerTaxInformation.new
  end
  ...
  describe 'test an instance of BuyerTaxInformation' do
    it 'should create an instance of BuyerTaxInformation' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::BuyerTaxInformation)
    end
  end
