...
# Unit tests for AmzSpApi::OrdersApiModelV0::RegulatedInformationField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegulatedInformationField' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::RegulatedInformationField.new
  end
  ...
  describe 'test an instance of RegulatedInformationField' do
    it 'should create an instance of RegulatedInformationField' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::RegulatedInformationField)
    end
  end
