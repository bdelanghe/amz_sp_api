...
# Unit tests for AmzSpApi::OrdersApiModelV0::ConfirmShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConfirmShipmentRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::ConfirmShipmentRequest.new
  end
  ...
  describe 'test an instance of ConfirmShipmentRequest' do
    it 'should create an instance of ConfirmShipmentRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::ConfirmShipmentRequest)
    end
  end
