...
# Unit tests for AmzSpApi::OrdersApiModelV0::Measurement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Measurement' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::Measurement.new
  end
  ...
  describe 'test an instance of Measurement' do
    it 'should create an instance of Measurement' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::Measurement)
    end
  end
