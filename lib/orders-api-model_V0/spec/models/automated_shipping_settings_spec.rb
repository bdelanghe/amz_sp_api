...
# Unit tests for AmzSpApi::OrdersApiModelV0::AutomatedShippingSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutomatedShippingSettings' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::AutomatedShippingSettings.new
  end
  ...
  describe 'test an instance of AutomatedShippingSettings' do
    it 'should create an instance of AutomatedShippingSettings' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::AutomatedShippingSettings)
    end
  end
