...
# Unit tests for AmzSpApi::OrdersApiModelV0::OrderAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderAddress' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::OrderAddress.new
  end
  ...
  describe 'test an instance of OrderAddress' do
    it 'should create an instance of OrderAddress' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::OrderAddress)
    end
  end
