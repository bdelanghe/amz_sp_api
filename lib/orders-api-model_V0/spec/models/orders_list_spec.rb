...
# Unit tests for AmzSpApi::OrdersApiModelV0::OrdersList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersList' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::OrdersList.new
  end
  ...
  describe 'test an instance of OrdersList' do
    it 'should create an instance of OrdersList' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::OrdersList)
    end
  end
