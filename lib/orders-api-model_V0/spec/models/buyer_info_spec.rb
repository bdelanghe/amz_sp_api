...
# Unit tests for AmzSpApi::OrdersApiModelV0::BuyerInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModelV0::BuyerInfo.new
  end
  ...
  describe 'test an instance of BuyerInfo' do
    it 'should create an instance of BuyerInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModelV0::BuyerInfo)
    end
  end
