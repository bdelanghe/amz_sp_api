...
describe AmzSpApi::FeedsApiModel20200904::Configuration do
  let(:config) { AmzSpApi::FeedsApiModel20200904::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::FeedsApiModel20200904.configure do |c|
    #   c.host = uri.host
