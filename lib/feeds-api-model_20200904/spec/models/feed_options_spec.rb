...
# Unit tests for AmzSpApi::FeedsApiModel20200904::FeedOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedOptions' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::FeedOptions.new
  end
  ...
  describe 'test an instance of FeedOptions' do
    it 'should create an instance of FeedOptions' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::FeedOptions)
    end
  end
end
