...
# Unit tests for AmzSpApi::FeedsApiModel20200904::FeedDocumentEncryptionDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedDocumentEncryptionDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::FeedDocumentEncryptionDetails.new
  end
  ...
  describe 'test an instance of FeedDocumentEncryptionDetails' do
    it 'should create an instance of FeedDocumentEncryptionDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::FeedDocumentEncryptionDetails)
    end
  end
