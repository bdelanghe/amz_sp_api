...
# Unit tests for AmzSpApi::FeedsApiModel20200904::GetFeedsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFeedsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::GetFeedsResponse.new
  end
  ...
  describe 'test an instance of GetFeedsResponse' do
    it 'should create an instance of GetFeedsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::GetFeedsResponse)
    end
  end
