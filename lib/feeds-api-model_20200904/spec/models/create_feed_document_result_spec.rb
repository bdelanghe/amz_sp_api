...
# Unit tests for AmzSpApi::FeedsApiModel20200904::CreateFeedDocumentResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedDocumentResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::CreateFeedDocumentResult.new
  end
  ...
  describe 'test an instance of CreateFeedDocumentResult' do
    it 'should create an instance of CreateFeedDocumentResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::CreateFeedDocumentResult)
    end
  end
