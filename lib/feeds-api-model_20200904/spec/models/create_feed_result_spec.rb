...
# Unit tests for AmzSpApi::FeedsApiModel20200904::CreateFeedResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::CreateFeedResult.new
  end
  ...
  describe 'test an instance of CreateFeedResult' do
    it 'should create an instance of CreateFeedResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::CreateFeedResult)
    end
  end
