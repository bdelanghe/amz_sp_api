...
# Unit tests for AmzSpApi::FeedsApiModel20200904::ErrorList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorList' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::ErrorList.new
  end
  ...
  describe 'test an instance of ErrorList' do
    it 'should create an instance of ErrorList' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::ErrorList)
    end
  end
end
