...
# Unit tests for AmzSpApi::FeedsApiModel20200904::FeedList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedList' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20200904::FeedList.new
  end
  ...
  describe 'test an instance of FeedList' do
    it 'should create an instance of FeedList' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20200904::FeedList)
    end
  end
end
