# AmzSpApi::SalesApiModelV0::SalesApi
...
```ruby
# load the gem
require 'sales-api-model_V0'

api_instance = AmzSpApi::SalesApiModelV0::SalesApi.new
...
begin
  ...
  p result
rescue AmzSpApi::SalesApiModelV0::ApiError => e
