...
# Unit tests for AmzSpApi::SalesApiModelV0::SalesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::SalesApiModelV0::SalesApi.new
  end
  ...
  describe 'test an instance of SalesApi' do
    it 'should create an instance of SalesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::SalesApiModelV0::SalesApi)
    end
  end
