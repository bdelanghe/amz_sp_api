...
AmzSpApi::SalesApiModelV0 - the Ruby gem for the Selling Partner API for Sales
...
```shell
gem build sales-api-model_V0.gemspec
```

Then either install the gem locally:

```shell
gem install ./sales-api-model_V0-0.1.0.gem
```
(for development, run `gem install --dev ./sales-api-model_V0-0.1.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'sales-api-model_V0', '~> 0.1.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'sales-api-model_V0', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::SalesApiModelV0::SalesApi* | [**get_order_metrics**](docs/SalesApi.md#get_order_metrics) | **GET** /sales/v1/orderMetrics | 

## Documentation for Models

 - [AmzSpApi::SalesApiModelV0::Decimal](docs/Decimal.md)
 - [AmzSpApi::SalesApiModelV0::Error](docs/Error.md)
 - [AmzSpApi::SalesApiModelV0::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::SalesApiModelV0::GetOrderMetricsResponse](docs/GetOrderMetricsResponse.md)
 - [AmzSpApi::SalesApiModelV0::Money](docs/Money.md)
 - [AmzSpApi::SalesApiModelV0::OrderMetricsInterval](docs/OrderMetricsInterval.md)
 - [AmzSpApi::SalesApiModelV0::OrderMetricsList](docs/OrderMetricsList.md)
