...
# Unit tests for AmzSpApi::FinancesApiModel::V0::Promotion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Promotion' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModel::V0::Promotion.new
  end
  ...
  describe 'test an instance of Promotion' do
    it 'should create an instance of Promotion' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModel::V0::Promotion)
    end
  end
