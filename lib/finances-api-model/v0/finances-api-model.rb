...
require 'finances-api-model/models/ebt_refund_reimbursement_only_event'
require 'finances-api-model/models/ebt_refund_reimbursement_only_event_list'
...
module AmzSpApi::FinancesApiModel::V0
  class << self
    ...
    #   AmzSpApi::FinancesApiModel::V0.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
