...
# Unit tests for AmzSpApi::FinancesApiModel::2024_06_19::ItemRelatedIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemRelatedIdentifier' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModel::2024_06_19::ItemRelatedIdentifier.new
  end
  ...
  describe 'test an instance of ItemRelatedIdentifier' do
    it 'should create an instance of ItemRelatedIdentifier' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModel::2024_06_19::ItemRelatedIdentifier)
    end
  end
