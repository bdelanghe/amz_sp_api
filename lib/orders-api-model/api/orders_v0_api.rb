...
module AmzSpApi::OrdersApiModel
  class OrdersV0Api
    ...
    # @option opts [String] :earliest_delivery_date_before A date used for selecting orders with a earliest delivery date before (or at) a specified time. The date must be in ISO 8601 format.
    # @option opts [String] :earliest_delivery_date_after A date used for selecting orders with a earliest delivery date after (or at) a specified time. The date must be in ISO 8601 format.
    # @option opts [String] :latest_delivery_date_before A date used for selecting orders with a latest delivery date before (or at) a specified time. The date must be in ISO 8601 format.
    # @option opts [String] :latest_delivery_date_after A date used for selecting orders with a latest delivery date after (or at) a specified time. The date must be in ISO 8601 format.
