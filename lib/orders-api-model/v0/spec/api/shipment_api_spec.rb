...
# Unit tests for AmzSpApi::OrdersApiModel::V0::ShipmentApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentApi' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::ShipmentApi.new
  end
  ...
  describe 'test an instance of ShipmentApi' do
    it 'should create an instance of ShipmentApi' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::ShipmentApi)
    end
  end
