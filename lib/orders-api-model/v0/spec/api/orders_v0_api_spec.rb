...
# Unit tests for AmzSpApi::OrdersApiModel::V0::OrdersV0Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersV0Api' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::OrdersV0Api.new
  end
  ...
  describe 'test an instance of OrdersV0Api' do
    it 'should create an instance of OrdersV0Api' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::OrdersV0Api)
    end
  end
