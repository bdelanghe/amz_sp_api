...
# Unit tests for AmzSpApi::OrdersApiModel::V0::FulfillmentInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentInstruction' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::FulfillmentInstruction.new
  end
  ...
  describe 'test an instance of FulfillmentInstruction' do
    it 'should create an instance of FulfillmentInstruction' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::FulfillmentInstruction)
    end
  end
