...
# Unit tests for AmzSpApi::OrdersApiModel::V0::TaxCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxCollection' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::TaxCollection.new
  end
  ...
  describe 'test an instance of TaxCollection' do
    it 'should create an instance of TaxCollection' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::TaxCollection)
    end
  end
