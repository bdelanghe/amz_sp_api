...
# Unit tests for AmzSpApi::OrdersApiModel::V0::OrderItemsInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemsInner' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::OrderItemsInner.new
  end
  ...
  describe 'test an instance of OrderItemsInner' do
    it 'should create an instance of OrderItemsInner' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::OrderItemsInner)
    end
  end
