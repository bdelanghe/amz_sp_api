...
# Unit tests for AmzSpApi::OrdersApiModel::V0::PointsGrantedDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PointsGrantedDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::PointsGrantedDetail.new
  end
  ...
  describe 'test an instance of PointsGrantedDetail' do
    it 'should create an instance of PointsGrantedDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::PointsGrantedDetail)
    end
  end
