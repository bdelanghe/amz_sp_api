...
# Unit tests for AmzSpApi::OrdersApiModel::V0::UpdateVerificationStatusRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateVerificationStatusRequestBody' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::UpdateVerificationStatusRequestBody.new
  end
  ...
  describe 'test an instance of UpdateVerificationStatusRequestBody' do
    it 'should create an instance of UpdateVerificationStatusRequestBody' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::UpdateVerificationStatusRequestBody)
    end
  end
