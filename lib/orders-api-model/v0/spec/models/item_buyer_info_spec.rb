...
# Unit tests for AmzSpApi::OrdersApiModel::V0::ItemBuyerInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemBuyerInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::ItemBuyerInfo.new
  end
  ...
  describe 'test an instance of ItemBuyerInfo' do
    it 'should create an instance of ItemBuyerInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::ItemBuyerInfo)
    end
  end
