...
# Unit tests for AmzSpApi::OrdersApiModel::V0::OrderAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderAddress' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::OrderAddress.new
  end
  ...
  describe 'test an instance of OrderAddress' do
    it 'should create an instance of OrderAddress' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::OrderAddress)
    end
  end
