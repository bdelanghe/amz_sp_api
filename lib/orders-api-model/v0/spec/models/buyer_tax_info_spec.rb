...
# Unit tests for AmzSpApi::OrdersApiModel::V0::BuyerTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerTaxInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::V0::BuyerTaxInfo.new
  end
  ...
  describe 'test an instance of BuyerTaxInfo' do
    it 'should create an instance of BuyerTaxInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::V0::BuyerTaxInfo)
    end
  end
