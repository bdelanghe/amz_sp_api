...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::OrderedQuantityDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderedQuantityDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::OrderedQuantityDetails.new
  end
  ...
  describe 'test an instance of OrderedQuantityDetails' do
    it 'should create an instance of OrderedQuantityDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::OrderedQuantityDetails)
    end
  end
