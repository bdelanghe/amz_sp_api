...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::AcknowledgementStatusDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcknowledgementStatusDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::AcknowledgementStatusDetails.new
  end
  ...
  describe 'test an instance of AcknowledgementStatusDetails' do
    it 'should create an instance of AcknowledgementStatusDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::AcknowledgementStatusDetails)
    end
  end
