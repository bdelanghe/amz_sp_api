...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::ImportDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::ImportDetails.new
  end
  ...
  describe 'test an instance of ImportDetails' do
    it 'should create an instance of ImportDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::ImportDetails)
    end
  end
