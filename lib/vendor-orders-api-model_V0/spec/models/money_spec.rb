...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::Money
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Money' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::Money.new
  end
  ...
  describe 'test an instance of Money' do
    it 'should create an instance of Money' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::Money)
    end
  end
