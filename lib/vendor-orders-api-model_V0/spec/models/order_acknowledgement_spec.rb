...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::OrderAcknowledgement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderAcknowledgement' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::OrderAcknowledgement.new
  end
  ...
  describe 'test an instance of OrderAcknowledgement' do
    it 'should create an instance of OrderAcknowledgement' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::OrderAcknowledgement)
    end
  end
