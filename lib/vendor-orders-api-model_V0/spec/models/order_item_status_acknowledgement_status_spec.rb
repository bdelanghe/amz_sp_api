...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusAcknowledgementStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemStatusAcknowledgementStatus' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusAcknowledgementStatus.new
  end
  ...
  describe 'test an instance of OrderItemStatusAcknowledgementStatus' do
    it 'should create an instance of OrderItemStatusAcknowledgementStatus' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusAcknowledgementStatus)
    end
  end
