...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::OrderItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::OrderItem.new
  end
  ...
  describe 'test an instance of OrderItem' do
    it 'should create an instance of OrderItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::OrderItem)
    end
  end
