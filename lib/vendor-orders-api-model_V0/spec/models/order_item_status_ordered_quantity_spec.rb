...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusOrderedQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemStatusOrderedQuantity' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusOrderedQuantity.new
  end
  ...
  describe 'test an instance of OrderItemStatusOrderedQuantity' do
    it 'should create an instance of OrderItemStatusOrderedQuantity' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::OrderItemStatusOrderedQuantity)
    end
  end
