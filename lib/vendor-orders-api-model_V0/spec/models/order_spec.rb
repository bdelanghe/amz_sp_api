...
# Unit tests for AmzSpApi::VendorOrdersApiModelV0::Order
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Order' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModelV0::Order.new
  end
  ...
  describe 'test an instance of Order' do
    it 'should create an instance of Order' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModelV0::Order)
    end
  end
