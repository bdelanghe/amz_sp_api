...
# Unit tests for AmzSpApi::ServicesApiModel::V1::FulfillmentTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentTime' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::FulfillmentTime.new
  end
  ...
  describe 'test an instance of FulfillmentTime' do
    it 'should create an instance of FulfillmentTime' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::FulfillmentTime)
    end
  end
