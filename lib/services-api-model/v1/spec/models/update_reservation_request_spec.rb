...
# Unit tests for AmzSpApi::ServicesApiModel::V1::UpdateReservationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateReservationRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::UpdateReservationRequest.new
  end
  ...
  describe 'test an instance of UpdateReservationRequest' do
    it 'should create an instance of UpdateReservationRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::UpdateReservationRequest)
    end
  end
