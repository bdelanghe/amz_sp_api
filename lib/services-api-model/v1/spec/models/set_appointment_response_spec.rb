...
# Unit tests for AmzSpApi::ServicesApiModel::V1::SetAppointmentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SetAppointmentResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::SetAppointmentResponse.new
  end
  ...
  describe 'test an instance of SetAppointmentResponse' do
    it 'should create an instance of SetAppointmentResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::SetAppointmentResponse)
    end
  end
