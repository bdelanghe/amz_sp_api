...
# Unit tests for AmzSpApi::ServicesApiModel::V1::ServiceDocumentUploadDestination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceDocumentUploadDestination' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::ServiceDocumentUploadDestination.new
  end
  ...
  describe 'test an instance of ServiceDocumentUploadDestination' do
    it 'should create an instance of ServiceDocumentUploadDestination' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::ServiceDocumentUploadDestination)
    end
  end
