...
# Unit tests for AmzSpApi::ServicesApiModel::V1::AddAppointmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddAppointmentRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::AddAppointmentRequest.new
  end
  ...
  describe 'test an instance of AddAppointmentRequest' do
    it 'should create an instance of AddAppointmentRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::AddAppointmentRequest)
    end
  end
