...
# Unit tests for AmzSpApi::ServicesApiModel::V1::AppointmentTimeInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppointmentTimeInput' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::AppointmentTimeInput.new
  end
  ...
  describe 'test an instance of AppointmentTimeInput' do
    it 'should create an instance of AppointmentTimeInput' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::AppointmentTimeInput)
    end
  end
