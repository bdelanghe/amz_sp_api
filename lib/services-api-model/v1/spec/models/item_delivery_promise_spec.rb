...
# Unit tests for AmzSpApi::ServicesApiModel::V1::ItemDeliveryPromise
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemDeliveryPromise' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::ItemDeliveryPromise.new
  end
  ...
  describe 'test an instance of ItemDeliveryPromise' do
    it 'should create an instance of ItemDeliveryPromise' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::ItemDeliveryPromise)
    end
  end
