...
# Unit tests for AmzSpApi::ServicesApiModel::V1::FulfillmentDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentDocument' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModel::V1::FulfillmentDocument.new
  end
  ...
  describe 'test an instance of FulfillmentDocument' do
    it 'should create an instance of FulfillmentDocument' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModel::V1::FulfillmentDocument)
    end
  end
