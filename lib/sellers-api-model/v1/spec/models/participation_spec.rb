...
# Unit tests for AmzSpApi::SellersApiModel::V1::Participation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Participation' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModel::V1::Participation.new
  end
  ...
  describe 'test an instance of Participation' do
    it 'should create an instance of Participation' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModel::V1::Participation)
    end
  end
