...
# Unit tests for AmzSpApi::SellersApiModel::V1::Marketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Marketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModel::V1::Marketplace.new
  end
  ...
  describe 'test an instance of Marketplace' do
    it 'should create an instance of Marketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModel::V1::Marketplace)
    end
  end
