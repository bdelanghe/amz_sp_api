...
# Unit tests for AmzSpApi::SellersApiModel::V1::MarketplaceParticipation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceParticipation' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModel::V1::MarketplaceParticipation.new
  end
  ...
  describe 'test an instance of MarketplaceParticipation' do
    it 'should create an instance of MarketplaceParticipation' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModel::V1::MarketplaceParticipation)
    end
  end
