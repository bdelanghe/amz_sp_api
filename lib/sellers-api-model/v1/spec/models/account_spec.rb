...
# Unit tests for AmzSpApi::SellersApiModel::V1::Account
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Account' do
  before do
    # run before each test
    @instance = AmzSpApi::SellersApiModel::V1::Account.new
  end
  ...
  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(@instance).to be_instance_of(AmzSpApi::SellersApiModel::V1::Account)
    end
  end
