...
describe AmzSpApi::ExternalFulfillmentInventory::Configuration do
  let(:config) { AmzSpApi::ExternalFulfillmentInventory::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ExternalFulfillmentInventory.configure do |c|
    #   c.host = uri.host
