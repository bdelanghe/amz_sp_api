...
# Unit tests for AmzSpApi::ExternalFulfillmentInventory::HttpMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpMethod' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillmentInventory::HttpMethod.new
  end
  ...
  describe 'test an instance of HttpMethod' do
    it 'should create an instance of HttpMethod' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillmentInventory::HttpMethod)
    end
  end
end
