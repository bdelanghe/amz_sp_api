...
# Unit tests for AmzSpApi::ApplicationIntegrationsApiModel::2024_04_01::CreateNotificationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateNotificationRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationIntegrationsApiModel::2024_04_01::CreateNotificationRequest.new
  end
  ...
  describe 'test an instance of CreateNotificationRequest' do
    it 'should create an instance of CreateNotificationRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationIntegrationsApiModel::2024_04_01::CreateNotificationRequest)
    end
  end
