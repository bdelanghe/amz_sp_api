...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrdersApiModelV1::TaxDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrdersApiModelV1::TaxDetails.new
  end
  ...
  describe 'test an instance of TaxDetails' do
    it 'should create an instance of TaxDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrdersApiModelV1::TaxDetails)
    end
  end
