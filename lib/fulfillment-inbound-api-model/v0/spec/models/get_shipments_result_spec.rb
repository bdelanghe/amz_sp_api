...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::V0::GetShipmentsResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetShipmentsResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModel::V0::GetShipmentsResult.new
  end
  ...
  describe 'test an instance of GetShipmentsResult' do
    it 'should create an instance of GetShipmentsResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::V0::GetShipmentsResult)
    end
  end
