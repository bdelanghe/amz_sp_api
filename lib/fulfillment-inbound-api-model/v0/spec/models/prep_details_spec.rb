...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::V0::PrepDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrepDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModel::V0::PrepDetails.new
  end
  ...
  describe 'test an instance of PrepDetails' do
    it 'should create an instance of PrepDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::V0::PrepDetails)
    end
  end
