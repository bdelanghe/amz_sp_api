...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::V0::AmazonPrepFeesDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonPrepFeesDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModel::V0::AmazonPrepFeesDetails.new
  end
  ...
  describe 'test an instance of AmazonPrepFeesDetails' do
    it 'should create an instance of AmazonPrepFeesDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::V0::AmazonPrepFeesDetails)
    end
  end
