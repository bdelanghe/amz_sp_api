...
# Unit tests for AmzSpApi::ProductPricingApiModel20220501::OfferIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfferIdentifier' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel20220501::OfferIdentifier.new
  end
  ...
  describe 'test an instance of OfferIdentifier' do
    it 'should create an instance of OfferIdentifier' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel20220501::OfferIdentifier)
    end
  end
