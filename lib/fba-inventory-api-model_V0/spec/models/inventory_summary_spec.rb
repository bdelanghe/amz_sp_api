...
# Unit tests for AmzSpApi::FbaInventoryApiModelV0::InventorySummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InventorySummary' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaInventoryApiModelV0::InventorySummary.new
  end
  ...
  describe 'test an instance of InventorySummary' do
    it 'should create an instance of InventorySummary' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaInventoryApiModelV0::InventorySummary)
    end
  end
