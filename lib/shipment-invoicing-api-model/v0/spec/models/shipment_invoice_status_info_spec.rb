...
# Unit tests for AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceStatusInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentInvoiceStatusInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceStatusInfo.new
  end
  ...
  describe 'test an instance of ShipmentInvoiceStatusInfo' do
    it 'should create an instance of ShipmentInvoiceStatusInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceStatusInfo)
    end
  end
