...
# Unit tests for AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentInvoiceApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceApi.new
  end
  ...
  describe 'test an instance of ShipmentInvoiceApi' do
    it 'should create an instance of ShipmentInvoiceApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentInvoiceApi)
    end
  end
