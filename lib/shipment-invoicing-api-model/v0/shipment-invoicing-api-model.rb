...
require 'shipment-invoicing-api-model/models/payment_information'
require 'shipment-invoicing-api-model/models/payment_information_list'
require 'shipment-invoicing-api-model/models/payment_method_detail_item_list'
require 'shipment-invoicing-api-model/models/payment_method_enum'
...
module AmzSpApi::ShipmentInvoicingApiModel::V0
  class << self
    ...
    #   AmzSpApi::ShipmentInvoicingApiModel::V0.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
