# AmzSpApi::CatalogItemsApiModelCatalogItemsV0::CatalogApi
...
```ruby
# load the gem
require 'catalog-items-api-model-catalogItemsV0'

api_instance = AmzSpApi::CatalogItemsApiModelCatalogItemsV0::CatalogApi.new
...
begin
  ...
  p result
rescue AmzSpApi::CatalogItemsApiModelCatalogItemsV0::ApiError => e
