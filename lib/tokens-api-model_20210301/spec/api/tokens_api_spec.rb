...
# Unit tests for AmzSpApi::TokensApiModel20210301::TokensApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TokensApi' do
  before do
    # run before each test
    @instance = AmzSpApi::TokensApiModel20210301::TokensApi.new
  end
  ...
  describe 'test an instance of TokensApi' do
    it 'should create an instance of TokensApi' do
      expect(@instance).to be_instance_of(AmzSpApi::TokensApiModel20210301::TokensApi)
    end
  end
