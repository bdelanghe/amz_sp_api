...
# Unit tests for AmzSpApi::FbaInventoryApiModel::V1::ResearchingQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResearchingQuantity' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaInventoryApiModel::V1::ResearchingQuantity.new
  end
  ...
  describe 'test an instance of ResearchingQuantity' do
    it 'should create an instance of ResearchingQuantity' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaInventoryApiModel::V1::ResearchingQuantity)
    end
  end
