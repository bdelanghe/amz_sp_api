...
# Unit tests for AmzSpApi::FbaInventoryApiModel::V1::FbaInventoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FbaInventoryApi' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaInventoryApiModel::V1::FbaInventoryApi.new
  end
  ...
  describe 'test an instance of FbaInventoryApi' do
    it 'should create an instance of FbaInventoryApi' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaInventoryApiModel::V1::FbaInventoryApi)
    end
  end
