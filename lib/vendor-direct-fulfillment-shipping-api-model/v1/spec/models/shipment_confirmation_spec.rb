...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::ShipmentConfirmation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentConfirmation' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::ShipmentConfirmation.new
  end
  ...
  describe 'test an instance of ShipmentConfirmation' do
    it 'should create an instance of ShipmentConfirmation' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::ShipmentConfirmation)
    end
  end
