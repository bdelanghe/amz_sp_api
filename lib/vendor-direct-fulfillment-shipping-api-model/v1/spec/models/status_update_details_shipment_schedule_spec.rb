...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::StatusUpdateDetailsShipmentSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusUpdateDetailsShipmentSchedule' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::StatusUpdateDetailsShipmentSchedule.new
  end
  ...
  describe 'test an instance of StatusUpdateDetailsShipmentSchedule' do
    it 'should create an instance of StatusUpdateDetailsShipmentSchedule' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::V1::StatusUpdateDetailsShipmentSchedule)
    end
  end
