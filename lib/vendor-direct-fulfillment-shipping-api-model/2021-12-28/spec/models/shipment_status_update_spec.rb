...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::ShipmentStatusUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentStatusUpdate' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::ShipmentStatusUpdate.new
  end
  ...
  describe 'test an instance of ShipmentStatusUpdate' do
    it 'should create an instance of ShipmentStatusUpdate' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::ShipmentStatusUpdate)
    end
  end
