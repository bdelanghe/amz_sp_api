...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::StatusUpdateDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusUpdateDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::StatusUpdateDetails.new
  end
  ...
  describe 'test an instance of StatusUpdateDetails' do
    it 'should create an instance of StatusUpdateDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::2021_12_28::StatusUpdateDetails)
    end
  end
