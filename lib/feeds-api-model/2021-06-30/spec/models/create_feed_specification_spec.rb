...
# Unit tests for AmzSpApi::FeedsApiModel::2021_06_30::CreateFeedSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel::2021_06_30::CreateFeedSpecification.new
  end
  ...
  describe 'test an instance of CreateFeedSpecification' do
    it 'should create an instance of CreateFeedSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel::2021_06_30::CreateFeedSpecification)
    end
  end
