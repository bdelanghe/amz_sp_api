...
# Unit tests for AmzSpApi::VendorDirectFulfillmentInventoryApiModel::V1::UpdateInventoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateInventoryApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentInventoryApiModel::V1::UpdateInventoryApi.new
  end
  ...
  describe 'test an instance of UpdateInventoryApi' do
    it 'should create an instance of UpdateInventoryApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentInventoryApiModel::V1::UpdateInventoryApi)
    end
  end
