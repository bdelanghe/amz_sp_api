...
[**submit_shipment_confirmation**](VendorShippingApi.md#submit_shipment_confirmation) | **POST** /vendor/shipping/v1/shipmentConfirmation | SubmitShipmentConfirmation
...
# **submit_shipment_confirmation**
> SubmitShipmentConfirmationResponse submit_shipment_confirmation(body)
...
api_instance = AmzSpApi::VendorShipmentsApiModel::VendorShippingApi.new
body = AmzSpApi::VendorShipmentsApiModel::SubmitShipmentConfirmationRequest.new # SubmitShipmentConfirmationRequest | A request to submit shipment confirmation.


begin
  #SubmitShipmentConfirmation
  result = api_instance.submit_shipment_confirmation(body)
  p result
rescue AmzSpApi::VendorShipmentsApiModel::ApiError => e
  puts "Exception when calling VendorShippingApi->submit_shipment_confirmation: #{e}"
end
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SubmitShipmentConfirmationRequest**](SubmitShipmentConfirmationRequest.md)| A request to submit shipment confirmation. | 

### Return type

[**SubmitShipmentConfirmationResponse**](SubmitShipmentConfirmationResponse.md)
