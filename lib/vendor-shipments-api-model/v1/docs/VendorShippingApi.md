# AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi
...
api_instance = AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi.new
opts = { 
...
begin
  ...
  p result
rescue AmzSpApi::VendorShipmentsApiModel::V1::ApiError => e
...
api_instance = AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi.new
body = AmzSpApi::VendorShipmentsApiModel::V1::SubmitShipmentConfirmationsRequest.new # SubmitShipmentConfirmationsRequest | A request to submit shipment confirmation.
...
api_instance = AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi.new
body = AmzSpApi::VendorShipmentsApiModel::V1::SubmitShipments.new # SubmitShipments | A request to submit shipment request.
