...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::PurchaseOrderItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseOrderItems' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::PurchaseOrderItems.new
  end
  ...
  describe 'test an instance of PurchaseOrderItems' do
    it 'should create an instance of PurchaseOrderItems' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::PurchaseOrderItems)
    end
  end
