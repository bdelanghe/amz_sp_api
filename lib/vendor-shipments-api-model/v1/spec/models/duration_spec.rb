...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::Duration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Duration' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::Duration.new
  end
  ...
  describe 'test an instance of Duration' do
    it 'should create an instance of Duration' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::Duration)
    end
  end
