...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::Stop
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stop' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::Stop.new
  end
  ...
  describe 'test an instance of Stop' do
    it 'should create an instance of Stop' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::Stop)
    end
  end
