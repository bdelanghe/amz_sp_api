...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::ShipmentMeasurements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentMeasurements' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::ShipmentMeasurements.new
  end
  ...
  describe 'test an instance of ShipmentMeasurements' do
    it 'should create an instance of ShipmentMeasurements' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::ShipmentMeasurements)
    end
  end
