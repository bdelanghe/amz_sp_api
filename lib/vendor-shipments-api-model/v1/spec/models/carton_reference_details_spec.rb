...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::CartonReferenceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartonReferenceDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::CartonReferenceDetails.new
  end
  ...
  describe 'test an instance of CartonReferenceDetails' do
    it 'should create an instance of CartonReferenceDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::CartonReferenceDetails)
    end
  end
