...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::ShipmentStatusDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentStatusDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::ShipmentStatusDetails.new
  end
  ...
  describe 'test an instance of ShipmentStatusDetails' do
    it 'should create an instance of ShipmentStatusDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::ShipmentStatusDetails)
    end
  end
