...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::PartyIdentification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyIdentification' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::PartyIdentification.new
  end
  ...
  describe 'test an instance of PartyIdentification' do
    it 'should create an instance of PartyIdentification' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::PartyIdentification)
    end
  end
