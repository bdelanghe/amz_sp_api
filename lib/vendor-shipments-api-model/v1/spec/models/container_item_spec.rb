...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::ContainerItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContainerItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::ContainerItem.new
  end
  ...
  describe 'test an instance of ContainerItem' do
    it 'should create an instance of ContainerItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::ContainerItem)
    end
  end
