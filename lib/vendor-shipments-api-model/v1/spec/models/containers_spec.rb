...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::V1::Containers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Containers' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::V1::Containers.new
  end
  ...
  describe 'test an instance of Containers' do
    it 'should create an instance of Containers' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::V1::Containers)
    end
  end
