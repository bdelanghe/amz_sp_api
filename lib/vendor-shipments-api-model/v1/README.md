...
AmzSpApi::VendorShipmentsApiModel::V1 - the Ruby gem for the Selling Partner API for Retail Procurement Shipments
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi* | [**get_shipment_details**](docs/VendorShippingApi.md#get_shipment_details) | **GET** /vendor/shipping/v1/shipments | GetShipmentDetails
*AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi* | [**get_shipment_labels**](docs/VendorShippingApi.md#get_shipment_labels) | **GET** /vendor/shipping/v1/transportLabels | 
*AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi* | [**submit_shipment_confirmations**](docs/VendorShippingApi.md#submit_shipment_confirmations) | **POST** /vendor/shipping/v1/shipmentConfirmations | SubmitShipmentConfirmations
*AmzSpApi::VendorShipmentsApiModel::V1::VendorShippingApi* | [**submit_shipments**](docs/VendorShippingApi.md#submit_shipments) | **POST** /vendor/shipping/v1/shipments | SubmitShipments

## Documentation for Models

 - [AmzSpApi::VendorShipmentsApiModel::V1::Address](docs/Address.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::CarrierDetails](docs/CarrierDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Carton](docs/Carton.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::CartonReferenceDetails](docs/CartonReferenceDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::CollectFreightPickupDetails](docs/CollectFreightPickupDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ContainerIdentification](docs/ContainerIdentification.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ContainerItem](docs/ContainerItem.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ContainerSequenceNumbers](docs/ContainerSequenceNumbers.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Containers](docs/Containers.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Decimal](docs/Decimal.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Dimensions](docs/Dimensions.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Duration](docs/Duration.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Error](docs/Error.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Expiry](docs/Expiry.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::GetShipmentDetailsResponse](docs/GetShipmentDetailsResponse.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::GetShipmentLabels](docs/GetShipmentLabels.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ImportDetails](docs/ImportDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::InnerContainersDetails](docs/InnerContainersDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Item](docs/Item.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ItemDetails](docs/ItemDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ItemQuantity](docs/ItemQuantity.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::LabelData](docs/LabelData.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Location](docs/Location.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Money](docs/Money.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::PackageItemDetails](docs/PackageItemDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::PackedItems](docs/PackedItems.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Pagination](docs/Pagination.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Pallet](docs/Pallet.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::PartyIdentification](docs/PartyIdentification.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::PurchaseOrderItems](docs/PurchaseOrderItems.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::PurchaseOrders](docs/PurchaseOrders.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::RegulationReferences](docs/RegulationReferences.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Route](docs/Route.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Shipment](docs/Shipment.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ShipmentConfirmation](docs/ShipmentConfirmation.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ShipmentDetails](docs/ShipmentDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ShipmentInformation](docs/ShipmentInformation.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ShipmentMeasurements](docs/ShipmentMeasurements.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::ShipmentStatusDetails](docs/ShipmentStatusDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Stop](docs/Stop.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::SubmitShipmentConfirmationsRequest](docs/SubmitShipmentConfirmationsRequest.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::SubmitShipmentConfirmationsResponse](docs/SubmitShipmentConfirmationsResponse.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::SubmitShipments](docs/SubmitShipments.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TaxRegistrationDetails](docs/TaxRegistrationDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TotalWeight](docs/TotalWeight.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransactionReference](docs/TransactionReference.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransportLabel](docs/TransportLabel.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransportShipmentMeasurements](docs/TransportShipmentMeasurements.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransportationDetails](docs/TransportationDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransportationDetailsForShipmentConfirmation](docs/TransportationDetailsForShipmentConfirmation.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::TransportationLabels](docs/TransportationLabels.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::VendorDetails](docs/VendorDetails.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Volume](docs/Volume.md)
 - [AmzSpApi::VendorShipmentsApiModel::V1::Weight](docs/Weight.md)
