# AmzSpApi::ExternalFulfillmentReturns::ReturnRetrievalApi
...
```ruby
# load the gem
require 'external-fulfillment-externalFulfillmentReturns'

api_instance = AmzSpApi::ExternalFulfillmentReturns::ReturnRetrievalApi.new
...
begin
  ...
  p result
rescue AmzSpApi::ExternalFulfillmentReturns::ApiError => e
