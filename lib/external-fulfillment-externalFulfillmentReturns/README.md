# external-fulfillment-externalFulfillmentReturns

AmzSpApi::ExternalFulfillmentReturns - the Ruby gem for the The Selling Partner API for Amazon External Fulfillment Return Item Processing
...
```shell
gem build external-fulfillment-externalFulfillmentReturns.gemspec
```

Then either install the gem locally:

```shell
gem install ./external-fulfillment-externalFulfillmentReturns-0.1.0.gem
```
(for development, run `gem install --dev ./external-fulfillment-externalFulfillmentReturns-0.1.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'external-fulfillment-externalFulfillmentReturns', '~> 0.1.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'external-fulfillment-externalFulfillmentReturns', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::ExternalFulfillmentReturns::ReturnRetrievalApi* | [**get_return**](docs/ReturnRetrievalApi.md#get_return) | **GET** /externalFulfillment/2024-09-11/returns/{returnId} | 
*AmzSpApi::ExternalFulfillmentReturns::ReturnRetrievalApi* | [**list_returns**](docs/ReturnRetrievalApi.md#list_returns) | **GET** /externalFulfillment/2024-09-11/returns | 

## Documentation for Models

 - [AmzSpApi::ExternalFulfillmentReturns::DateTime](docs/DateTime.md)
 - [AmzSpApi::ExternalFulfillmentReturns::Error](docs/Error.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::ExternalFulfillmentReturns::InvoiceInformation](docs/InvoiceInformation.md)
 - [AmzSpApi::ExternalFulfillmentReturns::MarketplaceChannel](docs/MarketplaceChannel.md)
 - [AmzSpApi::ExternalFulfillmentReturns::MarketplaceChannelDetails](docs/MarketplaceChannelDetails.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ModelReturn](docs/ModelReturn.md)
 - [AmzSpApi::ExternalFulfillmentReturns::OtpDetails](docs/OtpDetails.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ReplanningDetails](docs/ReplanningDetails.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ReturnMetadata](docs/ReturnMetadata.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ReturnShippingInfo](docs/ReturnShippingInfo.md)
 - [AmzSpApi::ExternalFulfillmentReturns::ReturnsResponse](docs/ReturnsResponse.md)
 - [AmzSpApi::ExternalFulfillmentReturns::TrackingInfo](docs/TrackingInfo.md)
