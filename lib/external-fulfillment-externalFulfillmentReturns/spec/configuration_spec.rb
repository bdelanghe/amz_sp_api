...
describe AmzSpApi::ExternalFulfillmentReturns::Configuration do
  let(:config) { AmzSpApi::ExternalFulfillmentReturns::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ExternalFulfillmentReturns.configure do |c|
    #   c.host = uri.host
