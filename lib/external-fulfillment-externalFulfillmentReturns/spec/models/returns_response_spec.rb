...
# Unit tests for AmzSpApi::ExternalFulfillmentReturns::ReturnsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReturnsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillmentReturns::ReturnsResponse.new
  end
  ...
  describe 'test an instance of ReturnsResponse' do
    it 'should create an instance of ReturnsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillmentReturns::ReturnsResponse)
    end
  end
