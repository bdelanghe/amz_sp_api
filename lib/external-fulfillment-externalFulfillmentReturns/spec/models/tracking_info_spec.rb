...
# Unit tests for AmzSpApi::ExternalFulfillmentReturns::TrackingInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillmentReturns::TrackingInfo.new
  end
  ...
  describe 'test an instance of TrackingInfo' do
    it 'should create an instance of TrackingInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillmentReturns::TrackingInfo)
    end
  end
