...
# Unit tests for AmzSpApi::FinancesApiModel20240619::Context
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Context' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModel20240619::Context.new
  end
  ...
  describe 'test an instance of Context' do
    it 'should create an instance of Context' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModel20240619::Context)
    end
  end
