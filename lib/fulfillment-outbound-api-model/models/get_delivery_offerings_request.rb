...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class GetDeliveryOfferingsRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FulfillmentOutboundApiModel::GetDeliveryOfferingsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FulfillmentOutboundApiModel::GetDeliveryOfferingsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @ship_from_country_code.nil?
        invalid_properties.push('invalid value for "ship_from_country_code", ship_from_country_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ship_from_country_code.nil?
    ...
    def hash
      [destination_address, ship_from_country_code, seller_sku, quantity].hash
    end
