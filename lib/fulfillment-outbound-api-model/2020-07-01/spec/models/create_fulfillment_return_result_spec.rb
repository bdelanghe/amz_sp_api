...
# Unit tests for AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::CreateFulfillmentReturnResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFulfillmentReturnResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::CreateFulfillmentReturnResult.new
  end
  ...
  describe 'test an instance of CreateFulfillmentReturnResult' do
    it 'should create an instance of CreateFulfillmentReturnResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::CreateFulfillmentReturnResult)
    end
  end
