...
# Unit tests for AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::FulfillmentShipmentPackage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentShipmentPackage' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::FulfillmentShipmentPackage.new
  end
  ...
  describe 'test an instance of FulfillmentShipmentPackage' do
    it 'should create an instance of FulfillmentShipmentPackage' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutboundApiModel::2020_07_01::FulfillmentShipmentPackage)
    end
  end
