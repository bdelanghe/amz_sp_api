...
module AmzSpApi::FulfillmentOutboundApiModel
  class FbaOutboundApi
    ...
    # @param body GetDeliveryOfferingsRequest parameter
    # @param [Hash] opts the optional parameters
    # @return [GetDeliveryOfferingsResponse]
    def delivery_offerings(body, opts = {})
      data, _status_code, _headers = delivery_offerings_with_http_info(body, opts)
      data
    end
    ...
    def delivery_offerings_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FbaOutboundApi.delivery_offerings ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FbaOutboundApi.delivery_offerings"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FbaOutboundApi#delivery_offerings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
