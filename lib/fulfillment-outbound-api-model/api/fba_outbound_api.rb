...
module AmzSpApi::FulfillmentOutboundApiModel
  class FbaOutboundApi
    ...
    def get_delivery_offerings(body, opts = {})
      data, _status_code, _headers = get_delivery_offerings_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDeliveryOfferingsResponse, Integer, Hash)>] GetDeliveryOfferingsResponse data, response status code and response headers
    def get_delivery_offerings_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FbaOutboundApi.get_delivery_offerings ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FbaOutboundApi.get_delivery_offerings"
      end
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/deliveryOfferings'
      ...
      return_type = opts[:return_type] || 'GetDeliveryOfferingsResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FbaOutboundApi#get_delivery_offerings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
