...
# Unit tests for AmzSpApi::ProductPricingApiModel::V0::ASINIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ASINIdentifier' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel::V0::ASINIdentifier.new
  end
  ...
  describe 'test an instance of ASINIdentifier' do
    it 'should create an instance of ASINIdentifier' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::V0::ASINIdentifier)
    end
  end
