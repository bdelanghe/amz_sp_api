...
# Unit tests for AmzSpApi::ProductPricingApiModel::V0::PriceType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PriceType' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel::V0::PriceType.new
  end
  ...
  describe 'test an instance of PriceType' do
    it 'should create an instance of PriceType' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::V0::PriceType)
    end
  end
