...
# Unit tests for AmzSpApi::ProductPricingApiModel::V0::SalesRankType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalesRankType' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel::V0::SalesRankType.new
  end
  ...
  describe 'test an instance of SalesRankType' do
    it 'should create an instance of SalesRankType' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::V0::SalesRankType)
    end
  end
