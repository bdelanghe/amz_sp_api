...
# Unit tests for AmzSpApi::ProductPricingApiModel::V0::ListingOffersRequestParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingOffersRequestParams' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel::V0::ListingOffersRequestParams.new
  end
  ...
  describe 'test an instance of ListingOffersRequestParams' do
    it 'should create an instance of ListingOffersRequestParams' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::V0::ListingOffersRequestParams)
    end
  end
