...
require 'product-pricing-api-model/models/competitive_summary_batch_request'
require 'product-pricing-api-model/models/competitive_summary_batch_response'
require 'product-pricing-api-model/models/competitive_summary_included_data'
require 'product-pricing-api-model/models/competitive_summary_request'
require 'product-pricing-api-model/models/competitive_summary_request_list'
require 'product-pricing-api-model/models/competitive_summary_response'
require 'product-pricing-api-model/models/competitive_summary_response_body'
require 'product-pricing-api-model/models/competitive_summary_response_list'
...
require 'product-pricing-api-model/models/featured_buying_option'
...
require 'product-pricing-api-model/models/featured_offer_segment'
...
require 'product-pricing-api-model/models/lowest_priced_offer'
require 'product-pricing-api-model/models/lowest_priced_offers_input'
require 'product-pricing-api-model/models/marketplace_id'
require 'product-pricing-api-model/models/money_type'
require 'product-pricing-api-model/models/offer'
require 'product-pricing-api-model/models/offer_identifier'
require 'product-pricing-api-model/models/points'
require 'product-pricing-api-model/models/postal_code'
require 'product-pricing-api-model/models/price'
require 'product-pricing-api-model/models/prime_details'
require 'product-pricing-api-model/models/reference_price'
require 'product-pricing-api-model/models/sample_location'
require 'product-pricing-api-model/models/segment'
require 'product-pricing-api-model/models/segment_details'
require 'product-pricing-api-model/models/segmented_featured_offer'
require 'product-pricing-api-model/models/shipping_option'
require 'product-pricing-api-model/models/sku'

# APIs
require 'product-pricing-api-model/api/product_pricing_api'

module AmzSpApi::ProductPricingApiModel::2022_05_01
  class << self
    # Customize default settings for the SDK using block.
    #   AmzSpApi::ProductPricingApiModel::2022_05_01.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
