...
describe AmzSpApi::ApplicationManagementApiModel::2023_11_30::Configuration do
  let(:config) { AmzSpApi::ApplicationManagementApiModel::2023_11_30::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ApplicationManagementApiModel::2023_11_30.configure do |c|
    #   c.host = uri.host
