...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModelV0::ShippingOfferingFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingOfferingFilter' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModelV0::ShippingOfferingFilter.new
  end
  ...
  describe 'test an instance of ShippingOfferingFilter' do
    it 'should create an instance of ShippingOfferingFilter' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModelV0::ShippingOfferingFilter)
    end
  end
