...
# Unit tests for AmzSpApi::ShippingApiModel::V1::RetrieveShippingLabelResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RetrieveShippingLabelResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V1::RetrieveShippingLabelResult.new
  end
  ...
  describe 'test an instance of RetrieveShippingLabelResult' do
    it 'should create an instance of RetrieveShippingLabelResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V1::RetrieveShippingLabelResult)
    end
  end
