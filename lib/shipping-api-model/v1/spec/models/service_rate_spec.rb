...
# Unit tests for AmzSpApi::ShippingApiModel::V1::ServiceRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceRate' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V1::ServiceRate.new
  end
  ...
  describe 'test an instance of ServiceRate' do
    it 'should create an instance of ServiceRate' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V1::ServiceRate)
    end
  end
