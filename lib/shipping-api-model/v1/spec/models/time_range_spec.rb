...
# Unit tests for AmzSpApi::ShippingApiModel::V1::TimeRange
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeRange' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V1::TimeRange.new
  end
  ...
  describe 'test an instance of TimeRange' do
    it 'should create an instance of TimeRange' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V1::TimeRange)
    end
  end
