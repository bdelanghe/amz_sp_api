...
# Unit tests for AmzSpApi::ShippingApiModel::V2::GetCarrierAccountsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCarrierAccountsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V2::GetCarrierAccountsResponse.new
  end
  ...
  describe 'test an instance of GetCarrierAccountsResponse' do
    it 'should create an instance of GetCarrierAccountsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V2::GetCarrierAccountsResponse)
    end
  end
