...
# Unit tests for AmzSpApi::ShippingApiModel::V2::CarrierAccountAttribute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierAccountAttribute' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V2::CarrierAccountAttribute.new
  end
  ...
  describe 'test an instance of CarrierAccountAttribute' do
    it 'should create an instance of CarrierAccountAttribute' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V2::CarrierAccountAttribute)
    end
  end
