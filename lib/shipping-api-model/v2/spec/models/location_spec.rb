...
# Unit tests for AmzSpApi::ShippingApiModel::V2::Location
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Location' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V2::Location.new
  end
  ...
  describe 'test an instance of Location' do
    it 'should create an instance of Location' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V2::Location)
    end
  end
