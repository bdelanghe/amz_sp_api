...
# Unit tests for AmzSpApi::ShippingApiModel::V2::Event
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Event' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V2::Event.new
  end
  ...
  describe 'test an instance of Event' do
    it 'should create an instance of Event' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V2::Event)
    end
  end
