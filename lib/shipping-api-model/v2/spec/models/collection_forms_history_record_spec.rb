...
# Unit tests for AmzSpApi::ShippingApiModel::V2::CollectionFormsHistoryRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionFormsHistoryRecord' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::V2::CollectionFormsHistoryRecord.new
  end
  ...
  describe 'test an instance of CollectionFormsHistoryRecord' do
    it 'should create an instance of CollectionFormsHistoryRecord' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::V2::CollectionFormsHistoryRecord)
    end
  end
