...
# Unit tests for AmzSpApi::FinancesApiModelFinances_20240619::DefaultApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefaultApi' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModelFinances_20240619::DefaultApi.new
  end
  ...
  describe 'test an instance of DefaultApi' do
    it 'should create an instance of DefaultApi' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModelFinances_20240619::DefaultApi)
    end
  end
