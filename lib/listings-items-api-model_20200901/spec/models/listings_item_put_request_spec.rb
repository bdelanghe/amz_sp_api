...
# Unit tests for AmzSpApi::ListingsItemsApiModel20200901::ListingsItemPutRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemPutRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel20200901::ListingsItemPutRequest.new
  end
  ...
  describe 'test an instance of ListingsItemPutRequest' do
    it 'should create an instance of ListingsItemPutRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel20200901::ListingsItemPutRequest)
    end
  end
