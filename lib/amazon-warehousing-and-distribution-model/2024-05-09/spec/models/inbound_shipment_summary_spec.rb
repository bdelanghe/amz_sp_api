...
# Unit tests for AmzSpApi::AmazonWarehousingAndDistributionModel::2024_05_09::InboundShipmentSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundShipmentSummary' do
  before do
    # run before each test
    @instance = AmzSpApi::AmazonWarehousingAndDistributionModel::2024_05_09::InboundShipmentSummary.new
  end
  ...
  describe 'test an instance of InboundShipmentSummary' do
    it 'should create an instance of InboundShipmentSummary' do
      expect(@instance).to be_instance_of(AmzSpApi::AmazonWarehousingAndDistributionModel::2024_05_09::InboundShipmentSummary)
    end
  end
