...
# Unit tests for AmzSpApi::NotificationsApiModel::V1::Subscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Subscription' do
  before do
    # run before each test
    @instance = AmzSpApi::NotificationsApiModel::V1::Subscription.new
  end
  ...
  describe 'test an instance of Subscription' do
    it 'should create an instance of Subscription' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::V1::Subscription)
    end
  end
