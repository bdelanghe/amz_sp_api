...
# Unit tests for AmzSpApi::NotificationsApiModel::V1::CreateSubscriptionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubscriptionRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::NotificationsApiModel::V1::CreateSubscriptionRequest.new
  end
  ...
  describe 'test an instance of CreateSubscriptionRequest' do
    it 'should create an instance of CreateSubscriptionRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::V1::CreateSubscriptionRequest)
    end
  end
