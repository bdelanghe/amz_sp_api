...
# Unit tests for AmzSpApi::NotificationsApiModel::V1::NotificationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::NotificationsApiModel::V1::NotificationsApi.new
  end
  ...
  describe 'test an instance of NotificationsApi' do
    it 'should create an instance of NotificationsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::V1::NotificationsApi)
    end
  end
