...
# Unit tests for AmzSpApi::ListingsRestrictionsApiModel::2021_08_01::Link
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Link' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsRestrictionsApiModel::2021_08_01::Link.new
  end
  ...
  describe 'test an instance of Link' do
    it 'should create an instance of Link' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsRestrictionsApiModel::2021_08_01::Link)
    end
  end
