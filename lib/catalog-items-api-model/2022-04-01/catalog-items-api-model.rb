...
require 'catalog-items-api-model/models/item_browse_classifications'
require 'catalog-items-api-model/models/item_browse_classifications_by_marketplace'
...
module AmzSpApi::CatalogItemsApiModel::2022_04_01
  class << self
    ...
    #   AmzSpApi::CatalogItemsApiModel::2022_04_01.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
