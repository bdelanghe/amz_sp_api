...
AmzSpApi::CatalogItemsApiModel::V0 - the Ruby gem for the Selling Partner API for Catalog Items
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::CatalogItemsApiModel::V0::CatalogApi* | [**list_catalog_categories**](docs/CatalogApi.md#list_catalog_categories) | **GET** /catalog/v0/categories | 

## Documentation for Models

 - [AmzSpApi::CatalogItemsApiModel::V0::Categories](docs/Categories.md)
 - [AmzSpApi::CatalogItemsApiModel::V0::Error](docs/Error.md)
 - [AmzSpApi::CatalogItemsApiModel::V0::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::CatalogItemsApiModel::V0::ListCatalogCategoriesResponse](docs/ListCatalogCategoriesResponse.md)
 - [AmzSpApi::CatalogItemsApiModel::V0::ListOfCategories](docs/ListOfCategories.md)
