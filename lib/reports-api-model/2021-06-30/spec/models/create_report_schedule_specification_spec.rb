...
# Unit tests for AmzSpApi::ReportsApiModel::2021_06_30::CreateReportScheduleSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportScheduleSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel::2021_06_30::CreateReportScheduleSpecification.new
  end
  ...
  describe 'test an instance of CreateReportScheduleSpecification' do
    it 'should create an instance of CreateReportScheduleSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel::2021_06_30::CreateReportScheduleSpecification)
    end
  end
