...
# Unit tests for AmzSpApi::ReportsApiModel::2021_06_30::GetReportsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel::2021_06_30::GetReportsResponse.new
  end
  ...
  describe 'test an instance of GetReportsResponse' do
    it 'should create an instance of GetReportsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel::2021_06_30::GetReportsResponse)
    end
  end
