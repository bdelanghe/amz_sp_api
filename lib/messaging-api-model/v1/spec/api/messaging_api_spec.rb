...
# Unit tests for AmzSpApi::MessagingApiModel::V1::MessagingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessagingApi' do
  before do
    # run before each test
    @instance = AmzSpApi::MessagingApiModel::V1::MessagingApi.new
  end
  ...
  describe 'test an instance of MessagingApi' do
    it 'should create an instance of MessagingApi' do
      expect(@instance).to be_instance_of(AmzSpApi::MessagingApiModel::V1::MessagingApi)
    end
  end
