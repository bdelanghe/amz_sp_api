...
# Unit tests for AmzSpApi::MessagingApiModel::V1::Attachment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Attachment' do
  before do
    # run before each test
    @instance = AmzSpApi::MessagingApiModel::V1::Attachment.new
  end
  ...
  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      expect(@instance).to be_instance_of(AmzSpApi::MessagingApiModel::V1::Attachment)
    end
  end
