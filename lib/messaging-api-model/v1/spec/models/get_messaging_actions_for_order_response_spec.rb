...
# Unit tests for AmzSpApi::MessagingApiModel::V1::GetMessagingActionsForOrderResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionsForOrderResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::MessagingApiModel::V1::GetMessagingActionsForOrderResponse.new
  end
  ...
  describe 'test an instance of GetMessagingActionsForOrderResponse' do
    it 'should create an instance of GetMessagingActionsForOrderResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::MessagingApiModel::V1::GetMessagingActionsForOrderResponse)
    end
  end
