...
# Unit tests for AmzSpApi::CatalogItemsApiModel20220401::CatalogItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogItemsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItemsApiModel20220401::CatalogItemsApi.new
  end
  ...
  describe 'test an instance of CatalogItemsApi' do
    it 'should create an instance of CatalogItemsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItemsApiModel20220401::CatalogItemsApi)
    end
  end
