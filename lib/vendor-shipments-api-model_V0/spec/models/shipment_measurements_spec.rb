...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::ShipmentMeasurements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentMeasurements' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::ShipmentMeasurements.new
  end
  ...
  describe 'test an instance of ShipmentMeasurements' do
    it 'should create an instance of ShipmentMeasurements' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::ShipmentMeasurements)
    end
  end
