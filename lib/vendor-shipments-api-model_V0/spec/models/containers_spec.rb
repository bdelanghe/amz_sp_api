...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::Containers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Containers' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::Containers.new
  end
  ...
  describe 'test an instance of Containers' do
    it 'should create an instance of Containers' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::Containers)
    end
  end
