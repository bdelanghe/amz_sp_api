...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::Duration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Duration' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::Duration.new
  end
  ...
  describe 'test an instance of Duration' do
    it 'should create an instance of Duration' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::Duration)
    end
  end
