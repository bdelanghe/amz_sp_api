...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::PurchaseOrderItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseOrderItems' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::PurchaseOrderItems.new
  end
  ...
  describe 'test an instance of PurchaseOrderItems' do
    it 'should create an instance of PurchaseOrderItems' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::PurchaseOrderItems)
    end
  end
