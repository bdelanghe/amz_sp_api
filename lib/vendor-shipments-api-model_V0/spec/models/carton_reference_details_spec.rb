...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::CartonReferenceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartonReferenceDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::CartonReferenceDetails.new
  end
  ...
  describe 'test an instance of CartonReferenceDetails' do
    it 'should create an instance of CartonReferenceDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::CartonReferenceDetails)
    end
  end
