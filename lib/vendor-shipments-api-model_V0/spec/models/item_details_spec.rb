...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::ItemDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::ItemDetails.new
  end
  ...
  describe 'test an instance of ItemDetails' do
    it 'should create an instance of ItemDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::ItemDetails)
    end
  end
