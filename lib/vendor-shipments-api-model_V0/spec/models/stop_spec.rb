...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::Stop
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stop' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::Stop.new
  end
  ...
  describe 'test an instance of Stop' do
    it 'should create an instance of Stop' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::Stop)
    end
  end
