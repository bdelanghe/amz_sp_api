...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::TaxRegistrationDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxRegistrationDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::TaxRegistrationDetails.new
  end
  ...
  describe 'test an instance of TaxRegistrationDetails' do
    it 'should create an instance of TaxRegistrationDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::TaxRegistrationDetails)
    end
  end
