...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::TransportationDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportationDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::TransportationDetails.new
  end
  ...
  describe 'test an instance of TransportationDetails' do
    it 'should create an instance of TransportationDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::TransportationDetails)
    end
  end
