...
# Unit tests for AmzSpApi::VendorShipmentsApiModelV0::ContainerItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContainerItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModelV0::ContainerItem.new
  end
  ...
  describe 'test an instance of ContainerItem' do
    it 'should create an instance of ContainerItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModelV0::ContainerItem)
    end
  end
