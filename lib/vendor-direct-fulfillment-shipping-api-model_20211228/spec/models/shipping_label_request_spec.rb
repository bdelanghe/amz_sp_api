...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::ShippingLabelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingLabelRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::ShippingLabelRequest.new
  end
  ...
  describe 'test an instance of ShippingLabelRequest' do
    it 'should create an instance of ShippingLabelRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::ShippingLabelRequest)
    end
  end
