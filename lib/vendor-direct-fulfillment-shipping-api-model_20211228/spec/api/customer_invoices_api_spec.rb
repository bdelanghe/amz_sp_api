...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::CustomerInvoicesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerInvoicesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::CustomerInvoicesApi.new
  end
  ...
  describe 'test an instance of CustomerInvoicesApi' do
    it 'should create an instance of CustomerInvoicesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::CustomerInvoicesApi)
    end
  end
