...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::VendorShippingLabelsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorShippingLabelsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::VendorShippingLabelsApi.new
  end
  ...
  describe 'test an instance of VendorShippingLabelsApi' do
    it 'should create an instance of VendorShippingLabelsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel20211228::VendorShippingLabelsApi)
    end
  end
