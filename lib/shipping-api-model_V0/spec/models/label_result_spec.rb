...
# Unit tests for AmzSpApi::ShippingApiModelV0::LabelResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV0::LabelResult.new
  end
  ...
  describe 'test an instance of LabelResult' do
    it 'should create an instance of LabelResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV0::LabelResult)
    end
  end
