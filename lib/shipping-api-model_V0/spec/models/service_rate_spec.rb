...
# Unit tests for AmzSpApi::ShippingApiModelV0::ServiceRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceRate' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV0::ServiceRate.new
  end
  ...
  describe 'test an instance of ServiceRate' do
    it 'should create an instance of ServiceRate' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV0::ServiceRate)
    end
  end
