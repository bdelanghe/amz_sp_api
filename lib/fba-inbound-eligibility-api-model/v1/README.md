...
AmzSpApi::FbaInboundEligibilityApiModel::V1 - the Ruby gem for the Selling Partner API for FBA Inbound Eligibilty
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::FbaInboundEligibilityApiModel::V1::FbaInboundApi* | [**get_item_eligibility_preview**](docs/FbaInboundApi.md#get_item_eligibility_preview) | **GET** /fba/inbound/v1/eligibility/itemPreview | 

## Documentation for Models

 - [AmzSpApi::FbaInboundEligibilityApiModel::V1::Error](docs/Error.md)
 - [AmzSpApi::FbaInboundEligibilityApiModel::V1::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::FbaInboundEligibilityApiModel::V1::GetItemEligibilityPreviewResponse](docs/GetItemEligibilityPreviewResponse.md)
 - [AmzSpApi::FbaInboundEligibilityApiModel::V1::ItemEligibilityPreview](docs/ItemEligibilityPreview.md)
