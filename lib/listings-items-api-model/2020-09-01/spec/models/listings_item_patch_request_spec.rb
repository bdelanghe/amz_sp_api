...
# Unit tests for AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPatchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemPatchRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPatchRequest.new
  end
  ...
  describe 'test an instance of ListingsItemPatchRequest' do
    it 'should create an instance of ListingsItemPatchRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPatchRequest)
    end
  end
