...
# Unit tests for AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPutRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemPutRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPutRequest.new
  end
  ...
  describe 'test an instance of ListingsItemPutRequest' do
    it 'should create an instance of ListingsItemPutRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::2020_09_01::ListingsItemPutRequest)
    end
  end
