...
require 'listings-items-api-model/models/item_product_type_by_marketplace'
require 'listings-items-api-model/models/item_product_types'
require 'listings-items-api-model/models/item_relationship'
require 'listings-items-api-model/models/item_relationships'
require 'listings-items-api-model/models/item_relationships_by_marketplace'
...
require 'listings-items-api-model/models/item_variation_theme'
...
module AmzSpApi::ListingsItemsApiModel::2021_08_01
  class << self
    ...
    #   AmzSpApi::ListingsItemsApiModel::2021_08_01.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
