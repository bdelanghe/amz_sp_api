...
# Unit tests for AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::AdditionalDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdditionalDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::AdditionalDetails.new
  end
  ...
  describe 'test an instance of AdditionalDetails' do
    it 'should create an instance of AdditionalDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::AdditionalDetails)
    end
  end
