...
# Unit tests for AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::InvoiceItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::InvoiceItem.new
  end
  ...
  describe 'test an instance of InvoiceItem' do
    it 'should create an instance of InvoiceItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentPaymentsApiModelV1::InvoiceItem)
    end
  end
