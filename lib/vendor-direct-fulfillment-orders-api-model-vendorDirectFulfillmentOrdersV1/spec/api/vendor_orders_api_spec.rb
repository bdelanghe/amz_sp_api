...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrdersApiModelVendorDirectFulfillmentOrdersV1::VendorOrdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorOrdersApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrdersApiModelVendorDirectFulfillmentOrdersV1::VendorOrdersApi.new
  end
  ...
  describe 'test an instance of VendorOrdersApi' do
    it 'should create an instance of VendorOrdersApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrdersApiModelVendorDirectFulfillmentOrdersV1::VendorOrdersApi)
    end
  end
