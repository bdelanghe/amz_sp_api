...
# Unit tests for AmzSpApi::8d::GetSolicitationActionsForOrderResponseLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSolicitationActionsForOrderResponseLinks' do
  before do
    # run before each test
    @instance = AmzSpApi::8d::GetSolicitationActionsForOrderResponseLinks.new
  end
  ...
  describe 'test an instance of GetSolicitationActionsForOrderResponseLinks' do
    it 'should create an instance of GetSolicitationActionsForOrderResponseLinks' do
      expect(@instance).to be_instance_of(AmzSpApi::8d::GetSolicitationActionsForOrderResponseLinks)
    end
  end
