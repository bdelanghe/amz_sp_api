...
# Unit tests for AmzSpApi::8d::GetSchemaResponseLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSchemaResponseLinks' do
  before do
    # run before each test
    @instance = AmzSpApi::8d::GetSchemaResponseLinks.new
  end
  ...
  describe 'test an instance of GetSchemaResponseLinks' do
    it 'should create an instance of GetSchemaResponseLinks' do
      expect(@instance).to be_instance_of(AmzSpApi::8d::GetSchemaResponseLinks)
    end
  end
