...
describe AmzSpApi::ApplicationManagementApiModel20231130::Configuration do
  let(:config) { AmzSpApi::ApplicationManagementApiModel20231130::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ApplicationManagementApiModel20231130.configure do |c|
    #   c.host = uri.host
