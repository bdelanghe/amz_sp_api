...
# Unit tests for AmzSpApi::ProductTypeDefinitionsApiModel::2020_09_01::SchemaLinkLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchemaLinkLink' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductTypeDefinitionsApiModel::2020_09_01::SchemaLinkLink.new
  end
  ...
  describe 'test an instance of SchemaLinkLink' do
    it 'should create an instance of SchemaLinkLink' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductTypeDefinitionsApiModel::2020_09_01::SchemaLinkLink)
    end
  end
