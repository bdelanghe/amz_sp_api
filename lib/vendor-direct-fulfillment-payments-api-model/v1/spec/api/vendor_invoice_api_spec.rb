...
# Unit tests for AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::VendorInvoiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorInvoiceApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::VendorInvoiceApi.new
  end
  ...
  describe 'test an instance of VendorInvoiceApi' do
    it 'should create an instance of VendorInvoiceApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::VendorInvoiceApi)
    end
  end
