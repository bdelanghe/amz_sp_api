...
# Unit tests for AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::TaxRegistrationDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxRegistrationDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::TaxRegistrationDetail.new
  end
  ...
  describe 'test an instance of TaxRegistrationDetail' do
    it 'should create an instance of TaxRegistrationDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::V1::TaxRegistrationDetail)
    end
  end
