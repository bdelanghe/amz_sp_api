...
# Unit tests for AmzSpApi::Transfers::PaymentMethodDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::Transfers::PaymentMethodDetails.new
  end
  ...
  describe 'test an instance of PaymentMethodDetails' do
    it 'should create an instance of PaymentMethodDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::Transfers::PaymentMethodDetails)
    end
  end
