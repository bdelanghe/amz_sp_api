# AmzSpApi::VendorInvoicesApiModel::V1::VendorPaymentsApi
...
api_instance = AmzSpApi::VendorInvoicesApiModel::V1::VendorPaymentsApi.new
body = AmzSpApi::VendorInvoicesApiModel::V1::SubmitInvoicesRequest.new # SubmitInvoicesRequest | The request body containing the invoice data to submit.


begin
  result = api_instance.submit_invoices(body)
  p result
rescue AmzSpApi::VendorInvoicesApiModel::V1::ApiError => e
