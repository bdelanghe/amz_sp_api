...
# Unit tests for AmzSpApi::VendorInvoicesApiModel::V1::VendorPaymentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorPaymentsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModel::V1::VendorPaymentsApi.new
  end
  ...
  describe 'test an instance of VendorPaymentsApi' do
    it 'should create an instance of VendorPaymentsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModel::V1::VendorPaymentsApi)
    end
  end
