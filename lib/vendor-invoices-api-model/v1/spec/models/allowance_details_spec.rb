...
# Unit tests for AmzSpApi::VendorInvoicesApiModel::V1::AllowanceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllowanceDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModel::V1::AllowanceDetails.new
  end
  ...
  describe 'test an instance of AllowanceDetails' do
    it 'should create an instance of AllowanceDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModel::V1::AllowanceDetails)
    end
  end
