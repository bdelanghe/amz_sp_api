...
# Unit tests for AmzSpApi::ProductFeesApiModelV0::FeesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModelV0::FeesApi.new
  end
  ...
  describe 'test an instance of FeesApi' do
    it 'should create an instance of FeesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModelV0::FeesApi)
    end
  end
