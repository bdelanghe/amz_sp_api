...
# Unit tests for AmzSpApi::ProductFeesApiModelV0::FeesEstimate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimate' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModelV0::FeesEstimate.new
  end
  ...
  describe 'test an instance of FeesEstimate' do
    it 'should create an instance of FeesEstimate' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModelV0::FeesEstimate)
    end
  end
