...
# Unit tests for AmzSpApi::ProductFeesApiModelV0::FeesEstimateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimateRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModelV0::FeesEstimateRequest.new
  end
  ...
  describe 'test an instance of FeesEstimateRequest' do
    it 'should create an instance of FeesEstimateRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModelV0::FeesEstimateRequest)
    end
  end
