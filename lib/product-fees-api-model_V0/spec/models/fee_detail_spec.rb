...
# Unit tests for AmzSpApi::ProductFeesApiModelV0::FeeDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModelV0::FeeDetail.new
  end
  ...
  describe 'test an instance of FeeDetail' do
    it 'should create an instance of FeeDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModelV0::FeeDetail)
    end
  end
