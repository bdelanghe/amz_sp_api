...
# Unit tests for AmzSpApi::ProductFeesApiModelV0::FeesEstimateByIdRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimateByIdRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesApiModelV0::FeesEstimateByIdRequest.new
  end
  ...
  describe 'test an instance of FeesEstimateByIdRequest' do
    it 'should create an instance of FeesEstimateByIdRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesApiModelV0::FeesEstimateByIdRequest)
    end
  end
