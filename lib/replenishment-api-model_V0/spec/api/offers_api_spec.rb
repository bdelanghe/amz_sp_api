...
# Unit tests for AmzSpApi::ReplenishmentApiModelV0::OffersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OffersApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ReplenishmentApiModelV0::OffersApi.new
  end
  ...
  describe 'test an instance of OffersApi' do
    it 'should create an instance of OffersApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ReplenishmentApiModelV0::OffersApi)
    end
  end
