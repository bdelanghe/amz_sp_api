...
# Unit tests for AmzSpApi::ReplenishmentApiModelV0::ListOfferMetricsRequestFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListOfferMetricsRequestFilters' do
  before do
    # run before each test
    @instance = AmzSpApi::ReplenishmentApiModelV0::ListOfferMetricsRequestFilters.new
  end
  ...
  describe 'test an instance of ListOfferMetricsRequestFilters' do
    it 'should create an instance of ListOfferMetricsRequestFilters' do
      expect(@instance).to be_instance_of(AmzSpApi::ReplenishmentApiModelV0::ListOfferMetricsRequestFilters)
    end
  end
