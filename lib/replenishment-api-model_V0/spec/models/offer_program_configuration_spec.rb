...
# Unit tests for AmzSpApi::ReplenishmentApiModelV0::OfferProgramConfiguration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfferProgramConfiguration' do
  before do
    # run before each test
    @instance = AmzSpApi::ReplenishmentApiModelV0::OfferProgramConfiguration.new
  end
  ...
  describe 'test an instance of OfferProgramConfiguration' do
    it 'should create an instance of OfferProgramConfiguration' do
      expect(@instance).to be_instance_of(AmzSpApi::ReplenishmentApiModelV0::OfferProgramConfiguration)
    end
  end
