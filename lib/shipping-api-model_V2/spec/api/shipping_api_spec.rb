...
# Unit tests for AmzSpApi::ShippingApiModelV2::ShippingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV2::ShippingApi.new
  end
  ...
  describe 'test an instance of ShippingApi' do
    it 'should create an instance of ShippingApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV2::ShippingApi)
    end
  end
  ...
  # @param body 
  # @param carrier_id The unique identifier associated with the carrier account.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :x_amzn_shipping_business_id Amazon shipping business to assume for this request. The default is AmazonShipping_UK.
