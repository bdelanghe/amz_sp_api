...
# Unit tests for AmzSpApi::ShippingApiModelV2::ExcludedBenefit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExcludedBenefit' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV2::ExcludedBenefit.new
  end
  ...
  describe 'test an instance of ExcludedBenefit' do
    it 'should create an instance of ExcludedBenefit' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV2::ExcludedBenefit)
    end
  end
