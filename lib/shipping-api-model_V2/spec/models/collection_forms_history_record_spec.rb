...
# Unit tests for AmzSpApi::ShippingApiModelV2::CollectionFormsHistoryRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionFormsHistoryRecord' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV2::CollectionFormsHistoryRecord.new
  end
  ...
  describe 'test an instance of CollectionFormsHistoryRecord' do
    it 'should create an instance of CollectionFormsHistoryRecord' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV2::CollectionFormsHistoryRecord)
    end
  end
