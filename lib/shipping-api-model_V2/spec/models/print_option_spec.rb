...
# Unit tests for AmzSpApi::ShippingApiModelV2::PrintOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrintOption' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModelV2::PrintOption.new
  end
  ...
  describe 'test an instance of PrintOption' do
    it 'should create an instance of PrintOption' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModelV2::PrintOption)
    end
  end
