# AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V1::VendorOrdersApi
...
api_instance = AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V1::VendorOrdersApi.new
...
begin
  ...
  p result
rescue AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V1::ApiError => e
...
api_instance = AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V1::VendorOrdersApi.new
body = AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V1::SubmitAcknowledgementRequest.new # SubmitAcknowledgementRequest | The request body containing the acknowledgement to an order.
