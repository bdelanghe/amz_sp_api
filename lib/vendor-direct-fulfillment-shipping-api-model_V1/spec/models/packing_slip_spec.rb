...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModelV1::PackingSlip
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackingSlip' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModelV1::PackingSlip.new
  end
  ...
  describe 'test an instance of PackingSlip' do
    it 'should create an instance of PackingSlip' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModelV1::PackingSlip)
    end
  end
