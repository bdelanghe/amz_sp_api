...
# Unit tests for AmzSpApi::VendorInvoicesApiModelV0::TotalWeight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TotalWeight' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModelV0::TotalWeight.new
  end
  ...
  describe 'test an instance of TotalWeight' do
    it 'should create an instance of TotalWeight' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModelV0::TotalWeight)
    end
  end
