...
# Unit tests for AmzSpApi::VendorInvoicesApiModelV0::ChargeDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChargeDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModelV0::ChargeDetails.new
  end
  ...
  describe 'test an instance of ChargeDetails' do
    it 'should create an instance of ChargeDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModelV0::ChargeDetails)
    end
  end
