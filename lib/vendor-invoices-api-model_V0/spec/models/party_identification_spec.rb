...
# Unit tests for AmzSpApi::VendorInvoicesApiModelV0::PartyIdentification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyIdentification' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModelV0::PartyIdentification.new
  end
  ...
  describe 'test an instance of PartyIdentification' do
    it 'should create an instance of PartyIdentification' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModelV0::PartyIdentification)
    end
  end
