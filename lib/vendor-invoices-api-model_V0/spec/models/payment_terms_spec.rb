...
# Unit tests for AmzSpApi::VendorInvoicesApiModelV0::PaymentTerms
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentTerms' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModelV0::PaymentTerms.new
  end
  ...
  describe 'test an instance of PaymentTerms' do
    it 'should create an instance of PaymentTerms' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModelV0::PaymentTerms)
    end
  end
