...
# Unit tests for AmzSpApi::SupplySourcesApiModel::2020_07_01::ThroughputConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThroughputConfig' do
  before do
    # run before each test
    @instance = AmzSpApi::SupplySourcesApiModel::2020_07_01::ThroughputConfig.new
  end
  ...
  describe 'test an instance of ThroughputConfig' do
    it 'should create an instance of ThroughputConfig' do
      expect(@instance).to be_instance_of(AmzSpApi::SupplySourcesApiModel::2020_07_01::ThroughputConfig)
    end
  end
