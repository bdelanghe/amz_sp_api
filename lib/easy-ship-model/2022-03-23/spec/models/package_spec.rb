...
# Unit tests for AmzSpApi::EasyShipModel::2022_03_23::Package
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Package' do
  before do
    # run before each test
    @instance = AmzSpApi::EasyShipModel::2022_03_23::Package.new
  end
  ...
  describe 'test an instance of Package' do
    it 'should create an instance of Package' do
      expect(@instance).to be_instance_of(AmzSpApi::EasyShipModel::2022_03_23::Package)
    end
  end
