...
# Unit tests for AmzSpApi::EasyShipModel::2022_03_23::ListHandoverSlotsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListHandoverSlotsRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::EasyShipModel::2022_03_23::ListHandoverSlotsRequest.new
  end
  ...
  describe 'test an instance of ListHandoverSlotsRequest' do
    it 'should create an instance of ListHandoverSlotsRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::EasyShipModel::2022_03_23::ListHandoverSlotsRequest)
    end
  end
