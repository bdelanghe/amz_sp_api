# AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::VendorShippingApi
...
```ruby
# load the gem
require 'vendor-direct-fulfillment-shipping-api-model-vendorDirectFulfillmentShippingV1'

api_instance = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::VendorShippingApi.new
...
begin
  ...
  p result
rescue AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::ApiError => e
...
api_instance = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::VendorShippingApi.new
body = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::SubmitShipmentConfirmationsRequest.new # SubmitShipmentConfirmationsRequest | Request body containing the shipment confirmations data.
...
api_instance = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::VendorShippingApi.new
body = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShippingV1::SubmitShipmentStatusUpdatesRequest.new # SubmitShipmentStatusUpdatesRequest | Request body containing the shipment status update data.
