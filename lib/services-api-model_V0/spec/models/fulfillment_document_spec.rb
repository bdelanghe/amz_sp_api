...
# Unit tests for AmzSpApi::ServicesApiModelV0::FulfillmentDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentDocument' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::FulfillmentDocument.new
  end
  ...
  describe 'test an instance of FulfillmentDocument' do
    it 'should create an instance of FulfillmentDocument' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::FulfillmentDocument)
    end
  end
