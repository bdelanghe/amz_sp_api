...
# Unit tests for AmzSpApi::ServicesApiModelV0::FulfillmentTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentTime' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::FulfillmentTime.new
  end
  ...
  describe 'test an instance of FulfillmentTime' do
    it 'should create an instance of FulfillmentTime' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::FulfillmentTime)
    end
  end
