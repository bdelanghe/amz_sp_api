...
# Unit tests for AmzSpApi::ServicesApiModelV0::FixedSlotCapacityQuery
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedSlotCapacityQuery' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::FixedSlotCapacityQuery.new
  end
  ...
  describe 'test an instance of FixedSlotCapacityQuery' do
    it 'should create an instance of FixedSlotCapacityQuery' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::FixedSlotCapacityQuery)
    end
  end
