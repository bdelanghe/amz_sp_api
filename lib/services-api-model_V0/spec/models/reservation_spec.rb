...
# Unit tests for AmzSpApi::ServicesApiModelV0::Reservation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Reservation' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::Reservation.new
  end
  ...
  describe 'test an instance of Reservation' do
    it 'should create an instance of Reservation' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::Reservation)
    end
  end
