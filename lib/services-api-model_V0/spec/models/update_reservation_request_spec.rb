...
# Unit tests for AmzSpApi::ServicesApiModelV0::UpdateReservationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateReservationRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::UpdateReservationRequest.new
  end
  ...
  describe 'test an instance of UpdateReservationRequest' do
    it 'should create an instance of UpdateReservationRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::UpdateReservationRequest)
    end
  end
