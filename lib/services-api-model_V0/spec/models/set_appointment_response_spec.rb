...
# Unit tests for AmzSpApi::ServicesApiModelV0::SetAppointmentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SetAppointmentResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::SetAppointmentResponse.new
  end
  ...
  describe 'test an instance of SetAppointmentResponse' do
    it 'should create an instance of SetAppointmentResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::SetAppointmentResponse)
    end
  end
