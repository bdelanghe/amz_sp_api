...
# Unit tests for AmzSpApi::ServicesApiModelV0::ServiceLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceLocation' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::ServiceLocation.new
  end
  ...
  describe 'test an instance of ServiceLocation' do
    it 'should create an instance of ServiceLocation' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::ServiceLocation)
    end
  end
