...
# Unit tests for AmzSpApi::ServicesApiModelV0::CreateReservationRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReservationRecord' do
  before do
    # run before each test
    @instance = AmzSpApi::ServicesApiModelV0::CreateReservationRecord.new
  end
  ...
  describe 'test an instance of CreateReservationRecord' do
    it 'should create an instance of CreateReservationRecord' do
      expect(@instance).to be_instance_of(AmzSpApi::ServicesApiModelV0::CreateReservationRecord)
    end
  end
