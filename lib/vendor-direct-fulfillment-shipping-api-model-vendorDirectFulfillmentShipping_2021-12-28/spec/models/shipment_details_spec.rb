...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShipping_20211228::ShipmentDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShipping_20211228::ShipmentDetails.new
  end
  ...
  describe 'test an instance of ShipmentDetails' do
    it 'should create an instance of ShipmentDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModelVendorDirectFulfillmentShipping_20211228::ShipmentDetails)
    end
  end
