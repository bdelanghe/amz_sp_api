...
# Unit tests for AmzSpApi::EasyShipModel20220323::EasyShipApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EasyShipApi' do
  before do
    # run before each test
    @instance = AmzSpApi::EasyShipModel20220323::EasyShipApi.new
  end
  ...
  describe 'test an instance of EasyShipApi' do
    it 'should create an instance of EasyShipApi' do
      expect(@instance).to be_instance_of(AmzSpApi::EasyShipModel20220323::EasyShipApi)
    end
  end
