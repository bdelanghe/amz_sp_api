# AmzSpApi::VendorDirectFulfillmentTransactionsApiModelVendorDirectFulfillmentTransactions_20211228::VendorTransactionApi
...
```ruby
# load the gem
require 'vendor-direct-fulfillment-transactions-api-model-vendorDirectFulfillmentTransactions_2021-12-28'

api_instance = AmzSpApi::VendorDirectFulfillmentTransactionsApiModelVendorDirectFulfillmentTransactions_20211228::VendorTransactionApi.new
...
begin
  ...
  p result
rescue AmzSpApi::VendorDirectFulfillmentTransactionsApiModelVendorDirectFulfillmentTransactions_20211228::ApiError => e
