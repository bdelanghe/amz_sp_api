...
# Unit tests for AmzSpApi::ExternalFulfillment::2024_09_11::TrackingInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillment::2024_09_11::TrackingInfo.new
  end
  ...
  describe 'test an instance of TrackingInfo' do
    it 'should create an instance of TrackingInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillment::2024_09_11::TrackingInfo)
    end
  end
