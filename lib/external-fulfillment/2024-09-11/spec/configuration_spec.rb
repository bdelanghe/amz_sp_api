...
describe AmzSpApi::ExternalFulfillment::2024_09_11::Configuration do
  let(:config) { AmzSpApi::ExternalFulfillment::2024_09_11::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ExternalFulfillment::2024_09_11.configure do |c|
    #   c.host = uri.host
