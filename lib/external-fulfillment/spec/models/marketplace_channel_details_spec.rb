...
# Unit tests for AmzSpApi::ExternalFulfillment::MarketplaceChannelDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceChannelDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillment::MarketplaceChannelDetails.new
  end
  ...
  describe 'test an instance of MarketplaceChannelDetails' do
    it 'should create an instance of MarketplaceChannelDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillment::MarketplaceChannelDetails)
    end
  end
