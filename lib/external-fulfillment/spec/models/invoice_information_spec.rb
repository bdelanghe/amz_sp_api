...
# Unit tests for AmzSpApi::ExternalFulfillment::InvoiceInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceInformation' do
  before do
    # run before each test
    @instance = AmzSpApi::ExternalFulfillment::InvoiceInformation.new
  end
  ...
  describe 'test an instance of InvoiceInformation' do
    it 'should create an instance of InvoiceInformation' do
      expect(@instance).to be_instance_of(AmzSpApi::ExternalFulfillment::InvoiceInformation)
    end
  end
