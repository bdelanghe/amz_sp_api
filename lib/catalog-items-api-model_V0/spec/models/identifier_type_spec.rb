...
# Unit tests for AmzSpApi::CatalogItemsApiModelV0::IdentifierType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdentifierType' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItemsApiModelV0::IdentifierType.new
  end
  ...
  describe 'test an instance of IdentifierType' do
    it 'should create an instance of IdentifierType' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItemsApiModelV0::IdentifierType)
    end
  end
