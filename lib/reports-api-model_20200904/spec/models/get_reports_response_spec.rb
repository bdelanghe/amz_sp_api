...
# Unit tests for AmzSpApi::ReportsApiModel20200904::GetReportsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::GetReportsResponse.new
  end
  ...
  describe 'test an instance of GetReportsResponse' do
    it 'should create an instance of GetReportsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::GetReportsResponse)
    end
  end
