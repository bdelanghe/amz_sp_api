...
# Unit tests for AmzSpApi::ReportsApiModel20200904::CancelReportScheduleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelReportScheduleResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::CancelReportScheduleResponse.new
  end
  ...
  describe 'test an instance of CancelReportScheduleResponse' do
    it 'should create an instance of CancelReportScheduleResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::CancelReportScheduleResponse)
    end
  end
