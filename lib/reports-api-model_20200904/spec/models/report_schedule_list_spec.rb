...
# Unit tests for AmzSpApi::ReportsApiModel20200904::ReportScheduleList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportScheduleList' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::ReportScheduleList.new
  end
  ...
  describe 'test an instance of ReportScheduleList' do
    it 'should create an instance of ReportScheduleList' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::ReportScheduleList)
    end
  end
end
