...
# Unit tests for AmzSpApi::ReportsApiModel20200904::ReportList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportList' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::ReportList.new
  end
  ...
  describe 'test an instance of ReportList' do
    it 'should create an instance of ReportList' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::ReportList)
    end
  end
end
