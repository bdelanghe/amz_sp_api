...
# Unit tests for AmzSpApi::ReportsApiModel20200904::CreateReportResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::CreateReportResult.new
  end
  ...
  describe 'test an instance of CreateReportResult' do
    it 'should create an instance of CreateReportResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::CreateReportResult)
    end
  end
