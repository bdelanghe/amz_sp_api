...
# Unit tests for AmzSpApi::ReportsApiModel20200904::CreateReportScheduleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportScheduleResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::CreateReportScheduleResponse.new
  end
  ...
  describe 'test an instance of CreateReportScheduleResponse' do
    it 'should create an instance of CreateReportScheduleResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::CreateReportScheduleResponse)
    end
  end
