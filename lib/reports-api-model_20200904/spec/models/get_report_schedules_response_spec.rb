...
# Unit tests for AmzSpApi::ReportsApiModel20200904::GetReportSchedulesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportSchedulesResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::GetReportSchedulesResponse.new
  end
  ...
  describe 'test an instance of GetReportSchedulesResponse' do
    it 'should create an instance of GetReportSchedulesResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::GetReportSchedulesResponse)
    end
  end
