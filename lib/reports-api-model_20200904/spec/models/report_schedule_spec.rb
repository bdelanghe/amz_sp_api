...
# Unit tests for AmzSpApi::ReportsApiModel20200904::ReportSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportSchedule' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::ReportSchedule.new
  end
  ...
  describe 'test an instance of ReportSchedule' do
    it 'should create an instance of ReportSchedule' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::ReportSchedule)
    end
  end
