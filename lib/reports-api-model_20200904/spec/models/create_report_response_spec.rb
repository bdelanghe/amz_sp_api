...
# Unit tests for AmzSpApi::ReportsApiModel20200904::CreateReportResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::CreateReportResponse.new
  end
  ...
  describe 'test an instance of CreateReportResponse' do
    it 'should create an instance of CreateReportResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::CreateReportResponse)
    end
  end
