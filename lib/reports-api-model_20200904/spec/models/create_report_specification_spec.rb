...
# Unit tests for AmzSpApi::ReportsApiModel20200904::CreateReportSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportsApiModel20200904::CreateReportSpecification.new
  end
  ...
  describe 'test an instance of CreateReportSpecification' do
    it 'should create an instance of CreateReportSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportsApiModel20200904::CreateReportSpecification)
    end
  end
