...
# Unit tests for AmzSpApi::FeedsApiModel20210630::Feed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Feed' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedsApiModel20210630::Feed.new
  end
  ...
  describe 'test an instance of Feed' do
    it 'should create an instance of Feed' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedsApiModel20210630::Feed)
    end
  end
