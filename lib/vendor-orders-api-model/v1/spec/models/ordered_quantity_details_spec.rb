...
# Unit tests for AmzSpApi::VendorOrdersApiModel::V1::OrderedQuantityDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderedQuantityDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModel::V1::OrderedQuantityDetails.new
  end
  ...
  describe 'test an instance of OrderedQuantityDetails' do
    it 'should create an instance of OrderedQuantityDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModel::V1::OrderedQuantityDetails)
    end
  end
