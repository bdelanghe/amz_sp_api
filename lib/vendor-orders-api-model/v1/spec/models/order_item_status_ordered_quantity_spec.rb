...
# Unit tests for AmzSpApi::VendorOrdersApiModel::V1::OrderItemStatusOrderedQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemStatusOrderedQuantity' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModel::V1::OrderItemStatusOrderedQuantity.new
  end
  ...
  describe 'test an instance of OrderItemStatusOrderedQuantity' do
    it 'should create an instance of OrderItemStatusOrderedQuantity' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModel::V1::OrderItemStatusOrderedQuantity)
    end
  end
