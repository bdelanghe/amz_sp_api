...
# Unit tests for AmzSpApi::VendorOrdersApiModel::V1::OrderStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderStatus' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModel::V1::OrderStatus.new
  end
  ...
  describe 'test an instance of OrderStatus' do
    it 'should create an instance of OrderStatus' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModel::V1::OrderStatus)
    end
  end
