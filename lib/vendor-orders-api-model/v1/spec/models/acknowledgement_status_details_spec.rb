...
# Unit tests for AmzSpApi::VendorOrdersApiModel::V1::AcknowledgementStatusDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcknowledgementStatusDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorOrdersApiModel::V1::AcknowledgementStatusDetails.new
  end
  ...
  describe 'test an instance of AcknowledgementStatusDetails' do
    it 'should create an instance of AcknowledgementStatusDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorOrdersApiModel::V1::AcknowledgementStatusDetails)
    end
  end
