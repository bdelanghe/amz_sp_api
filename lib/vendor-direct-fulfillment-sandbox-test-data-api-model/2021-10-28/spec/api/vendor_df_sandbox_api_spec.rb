...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::2021_10_28::VendorDFSandboxApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorDFSandboxApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::2021_10_28::VendorDFSandboxApi.new
  end
  ...
  describe 'test an instance of VendorDFSandboxApi' do
    it 'should create an instance of VendorDFSandboxApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::2021_10_28::VendorDFSandboxApi)
    end
  end
