...
require 'merchant-fulfillment-api-model/models/adjustment_item_list'
...
require 'merchant-fulfillment-api-model/models/rate_item'
require 'merchant-fulfillment-api-model/models/rate_item_id'
require 'merchant-fulfillment-api-model/models/rate_item_type'
...
module AmzSpApi::MerchantFulfillmentApiModel::V0
  class << self
    ...
    #   AmzSpApi::MerchantFulfillmentApiModel::V0.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
