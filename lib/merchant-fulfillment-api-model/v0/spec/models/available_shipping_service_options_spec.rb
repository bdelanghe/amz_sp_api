...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableShippingServiceOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AvailableShippingServiceOptions' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableShippingServiceOptions.new
  end
  ...
  describe 'test an instance of AvailableShippingServiceOptions' do
    it 'should create an instance of AvailableShippingServiceOptions' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableShippingServiceOptions)
    end
  end
