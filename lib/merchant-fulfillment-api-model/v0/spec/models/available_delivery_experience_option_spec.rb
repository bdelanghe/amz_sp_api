...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableDeliveryExperienceOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AvailableDeliveryExperienceOption' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableDeliveryExperienceOption.new
  end
  ...
  describe 'test an instance of AvailableDeliveryExperienceOption' do
    it 'should create an instance of AvailableDeliveryExperienceOption' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::AvailableDeliveryExperienceOption)
    end
  end
