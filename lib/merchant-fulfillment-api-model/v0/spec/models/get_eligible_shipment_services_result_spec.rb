...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::GetEligibleShipmentServicesResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEligibleShipmentServicesResult' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::GetEligibleShipmentServicesResult.new
  end
  ...
  describe 'test an instance of GetEligibleShipmentServicesResult' do
    it 'should create an instance of GetEligibleShipmentServicesResult' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::GetEligibleShipmentServicesResult)
    end
  end
