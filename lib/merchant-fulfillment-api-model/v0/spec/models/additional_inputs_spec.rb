...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::AdditionalInputs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdditionalInputs' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::AdditionalInputs.new
  end
  ...
  describe 'test an instance of AdditionalInputs' do
    it 'should create an instance of AdditionalInputs' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::AdditionalInputs)
    end
  end
