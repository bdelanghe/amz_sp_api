...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::CreateShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateShipmentRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::CreateShipmentRequest.new
  end
  ...
  describe 'test an instance of CreateShipmentRequest' do
    it 'should create an instance of CreateShipmentRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::CreateShipmentRequest)
    end
  end
