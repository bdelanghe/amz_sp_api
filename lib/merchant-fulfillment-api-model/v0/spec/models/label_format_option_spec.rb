...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::LabelFormatOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelFormatOption' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::LabelFormatOption.new
  end
  ...
  describe 'test an instance of LabelFormatOption' do
    it 'should create an instance of LabelFormatOption' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::LabelFormatOption)
    end
  end
