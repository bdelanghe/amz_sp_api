...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::GetAdditionalSellerInputsResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAdditionalSellerInputsResult' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::GetAdditionalSellerInputsResult.new
  end
  ...
  describe 'test an instance of GetAdditionalSellerInputsResult' do
    it 'should create an instance of GetAdditionalSellerInputsResult' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::GetAdditionalSellerInputsResult)
    end
  end
