...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::V0::LabelDimensions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelDimensions' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::V0::LabelDimensions.new
  end
  ...
  describe 'test an instance of LabelDimensions' do
    it 'should create an instance of LabelDimensions' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::V0::LabelDimensions)
    end
  end
