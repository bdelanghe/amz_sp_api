...
AmzSpApi::FulfillmentInboundApiModel - the Ruby gem for the Fulfillment Inbound API
...
api_instance = AmzSpApi::FulfillmentInboundApiModel::DefaultApi.new
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::FulfillmentInboundApiModel::DefaultApi* | [**test_get**](docs/DefaultApi.md#test_get) | **GET** /test | 
